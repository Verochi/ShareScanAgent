...
public class CCMkattr extends org.apache.tools.ant.taskdefs.optional.clearcase.ClearCase {
    ...
    public void execute() throws org.apache.tools.ant.BuildException {
        ...
        if (getTypeValue() == null) {
            throw new org.apache.tools.ant.BuildException("Required attribute TypeValue not specified");
        }
        if (getViewPath() == null) {
            setViewPath(project.getBaseDir().getPath());
        }
        commandline.setExecutable(getClearToolCommand());
        commandline.createArgument().setValue(org.apache.tools.ant.taskdefs.optional.clearcase.ClearCase.COMMAND_MKATTR);
        c(commandline);
        if (!getFailOnErr()) {
    ...
    public final void g(org.apache.tools.ant.types.Commandline commandline) {
        ...
        java.lang.String typeValue = getTypeValue();
        if (typeValue != null) {
    ...
    public final void h(org.apache.tools.ant.types.Commandline commandline) {
        if (getVersion() != null) {
    ...
    public void setTypeValue(java.lang.String str) {
        this.D = str;
    }
