...
public class MethodRefCPInfo extends org.apache.tools.ant.taskdefs.optional.depend.constantpool.ConstantPoolEntry {
    ...
    public java.lang.String toString() {
        if (!isResolved()) {
            return "Method : Class index = " + this.g + ", name and type index = " + this.h;
        }
        return "Method : Class = " + this.d + ", name = " + this.e + ", type = " + this.f;
    }
}
