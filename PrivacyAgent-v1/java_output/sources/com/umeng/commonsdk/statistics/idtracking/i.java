...
public class i extends com.umeng.commonsdk.statistics.idtracking.a {
    ...
    public static final java.lang.String c = "key_umeng_sp_oaid_required_time";
    private static final java.lang.String d = "oaid";
    ...
    public java.lang.String f() {
        if (!com.umeng.commonsdk.UMConfigure.shouldCollectOaid()) {
            com.umeng.commonsdk.debug.UMRTLog.i(com.umeng.commonsdk.debug.UMRTLog.RTLOG_TAG, "--->>>*** OaidTracking.getId(): oaid开关已关闭。");
            return null;
        }
        ...
        try {
            android.content.SharedPreferences sharedPreferences = this.e.getSharedPreferences(a, 0);
