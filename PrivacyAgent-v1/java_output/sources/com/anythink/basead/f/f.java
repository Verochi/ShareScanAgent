...
public class f extends com.anythink.basead.f.c {
    public static final java.lang.String a = "f";
    private com.anythink.basead.e.j k;

    /* renamed from: com.anythink.basead.f.f$1, reason: invalid class name */
    public class AnonymousClass1 implements com.anythink.basead.e.b.InterfaceC0141b {
        ...
        public final void a() {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onVideoAdPlayStart();
            }
        }
        ...
        public final void a(com.anythink.basead.c.e eVar) {
            ...
            eVar.c();
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onShowFailed(eVar);
            }
        }
        ...
        public final void a(com.anythink.basead.e.i iVar) {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onAdShow(iVar);
            }
        }
        ...
        public final void a(boolean z) {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onDeeplinkCallback(z);
            }
        }
        ...
        public final void b() {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onVideoAdPlayEnd();
            }
        }
        ...
        public final void b(com.anythink.basead.e.i iVar) {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onAdClick(iVar);
            }
        }
        ...
        public final void c() {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onRewarded();
            }
        }
        ...
        public final void d() {
            java.lang.String str = com.anythink.basead.f.f.a;
            if (com.anythink.basead.f.f.this.k != null) {
                com.anythink.basead.f.f.this.k.onAdClosed();
            }
            com.anythink.basead.e.b.a().b(this.a);
        }
    }

    public f(android.content.Context context, com.anythink.core.common.f.m mVar, java.lang.String str, boolean z) {
    ...
    public final void a(android.app.Activity activity, java.util.Map<java.lang.String, java.lang.Object> map) {
        try {
            ...
            com.anythink.basead.e.b.a().a(str, new com.anythink.basead.f.f.AnonymousClass1(str));
