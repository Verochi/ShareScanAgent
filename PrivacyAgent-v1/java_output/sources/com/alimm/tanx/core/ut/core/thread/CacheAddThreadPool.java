...
public class CacheAddThreadPool {
    ...
    /* renamed from: com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool$1, reason: invalid class name */
    public static class AnonymousClass1 implements java.util.concurrent.ThreadFactory {
        ...
        public java.lang.Thread newThread(@androidx.annotation.NonNull java.lang.Runnable runnable) {
            return new java.lang.Thread(runnable, "UserReportAddThreadPool-" + com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool.access$008());
        }
    }

    /* renamed from: com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool$2, reason: invalid class name */
    ...
    /* renamed from: com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool$3, reason: invalid class name */
    public static class AnonymousClass3 implements java.lang.Runnable {
        ...
        public void run() {
            com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool.post(this.val$runnable);
        }
    }

    static {
        java.util.concurrent.ThreadPoolExecutor threadPoolExecutor = new java.util.concurrent.ThreadPoolExecutor(1, 1, 60L, java.util.concurrent.TimeUnit.SECONDS, new java.util.concurrent.LinkedBlockingQueue(100), new com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool.AnonymousClass1());
        sExecutor = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
        threadPoolExecutor.setRejectedExecutionHandler(new com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool.AnonymousClass2());
    }
    ...
    public static void postDelayed(@androidx.annotation.NonNull java.lang.Runnable runnable, int i) {
        if (i == 0) {
            ...
            sHandler.postDelayed(new com.alimm.tanx.core.ut.core.thread.CacheAddThreadPool.AnonymousClass3(runnable), i);
        }
    }
