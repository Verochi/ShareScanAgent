...
public class UserReportThreadPool {
    ...
    private static final java.lang.String TAG = "UserReportThreadPool";
    private static final java.util.concurrent.ThreadPoolExecutor sExecutor;
    private static android.os.Handler sHandler;
    private static long sIndex;

    /* renamed from: com.alimm.tanx.core.ut.core.thread.UserReportThreadPool$1, reason: invalid class name */
    public static class AnonymousClass1 implements java.util.concurrent.ThreadFactory {
        ...
        public java.lang.Thread newThread(@androidx.annotation.NonNull java.lang.Runnable runnable) {
            return new java.lang.Thread(runnable, "UserReportThread-" + com.alimm.tanx.core.ut.core.thread.UserReportThreadPool.access$008());
        }
    }

    /* renamed from: com.alimm.tanx.core.ut.core.thread.UserReportThreadPool$2, reason: invalid class name */
    ...
    /* renamed from: com.alimm.tanx.core.ut.core.thread.UserReportThreadPool$3, reason: invalid class name */
    public static class AnonymousClass3 implements java.lang.Runnable {
        ...
        public void run() {
            com.alimm.tanx.core.ut.core.thread.UserReportThreadPool.post(this.val$runnable);
        }
    }

    static {
        java.util.concurrent.ThreadPoolExecutor threadPoolExecutor = new java.util.concurrent.ThreadPoolExecutor(2, 8, 60L, java.util.concurrent.TimeUnit.SECONDS, new java.util.concurrent.LinkedBlockingQueue(100), new com.alimm.tanx.core.ut.core.thread.UserReportThreadPool.AnonymousClass1());
        sExecutor = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
        threadPoolExecutor.setRejectedExecutionHandler(new com.alimm.tanx.core.ut.core.thread.UserReportThreadPool.AnonymousClass2());
    }
    ...
    public static void postDelayed(@androidx.annotation.NonNull java.lang.Runnable runnable, int i) {
        if (i == 0) {
            ...
            sHandler.postDelayed(new com.alimm.tanx.core.ut.core.thread.UserReportThreadPool.AnonymousClass3(runnable), i);
        }
    }
