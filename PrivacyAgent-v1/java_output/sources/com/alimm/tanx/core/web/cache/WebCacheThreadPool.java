...
public class WebCacheThreadPool {
    ...
    private static final java.lang.String TAG = "WebCacheThreadPool";
    private static final java.util.concurrent.ThreadPoolExecutor sExecutor;
    private static android.os.Handler sHandler;
    private static long sIndex;

    /* renamed from: com.alimm.tanx.core.web.cache.WebCacheThreadPool$1, reason: invalid class name */
    public static class AnonymousClass1 implements java.util.concurrent.ThreadFactory {
        ...
        public java.lang.Thread newThread(@androidx.annotation.NonNull java.lang.Runnable runnable) {
            return new java.lang.Thread(runnable, "WebCacheThreadPool-" + com.alimm.tanx.core.web.cache.WebCacheThreadPool.access$008());
        }
    }

    /* renamed from: com.alimm.tanx.core.web.cache.WebCacheThreadPool$2, reason: invalid class name */
    ...
    /* renamed from: com.alimm.tanx.core.web.cache.WebCacheThreadPool$3, reason: invalid class name */
    public static class AnonymousClass3 implements java.lang.Runnable {
        ...
        public void run() {
            com.alimm.tanx.core.web.cache.WebCacheThreadPool.post(this.val$runnable);
        }
    }

    static {
        java.util.concurrent.ThreadPoolExecutor threadPoolExecutor = new java.util.concurrent.ThreadPoolExecutor(1, 1, 60L, java.util.concurrent.TimeUnit.SECONDS, new java.util.concurrent.LinkedBlockingQueue(100), new com.alimm.tanx.core.web.cache.WebCacheThreadPool.AnonymousClass1());
        sExecutor = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
        threadPoolExecutor.setRejectedExecutionHandler(new com.alimm.tanx.core.web.cache.WebCacheThreadPool.AnonymousClass2());
    }
    ...
    public static void postDelayed(@androidx.annotation.NonNull java.lang.Runnable runnable, int i) {
        if (i == 0) {
            ...
            sHandler.postDelayed(new com.alimm.tanx.core.web.cache.WebCacheThreadPool.AnonymousClass3(runnable), i);
        }
    }
