...
public interface INetWork<T> {
    ...
    void sendHttpPost(com.alimm.tanx.core.net.bean.RequestBean requestBean, java.lang.Class<T> cls, boolean z, com.alimm.tanx.core.net.callback.NetWorkCallBack netWorkCallBack);
