...
public class NetWorkManager<T> implements com.alimm.tanx.core.ad.listener.net.INetWork<T>, com.alimm.tanx.core.utils.NotConfused {
    private static final java.lang.String TAG = "NetWorkManager";
    private static com.alimm.tanx.ui.net.NetWorkManager instance;
    private com.alimm.tanx.core.ad.listener.net.INetWork iNetWork;

    public NetWorkManager() {
    }

    public NetWorkManager(com.alimm.tanx.core.ad.listener.net.INetWork iNetWork) {
        this.iNetWork = iNetWork;
    }

    public static com.alimm.tanx.ui.net.NetWorkManager getInstance() {
        if (instance == null) {
            synchronized (com.alimm.tanx.ui.net.NetWorkManager.class) {
            }
        }
        return instance;
    }
    ...
    public void cancelOkHttpTag(java.lang.String str) {
        com.alimm.tanx.core.ad.listener.net.INetWork iNetWork = this.iNetWork;
        if (iNetWork != null) {
    ...
    public void setINetWork(com.alimm.tanx.core.ad.listener.net.INetWork iNetWork) {
        this.iNetWork = iNetWork;
    }
}
