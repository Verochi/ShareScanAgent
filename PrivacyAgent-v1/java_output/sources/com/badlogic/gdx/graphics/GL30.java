...
public interface GL30 extends com.badlogic.gdx.graphics.GL20 {
    ...
    void glClearBufferfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glClearBufferiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glClearBufferuiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glDeleteQueries(int i, java.nio.IntBuffer intBuffer);

    void glDeleteQueries(int i, int[] iArr, int i2);

    void glDeleteSamplers(int i, java.nio.IntBuffer intBuffer);

    void glDeleteSamplers(int i, int[] iArr, int i2);

    void glDeleteTransformFeedbacks(int i, java.nio.IntBuffer intBuffer);

    void glDeleteTransformFeedbacks(int i, int[] iArr, int i2);

    void glDeleteVertexArrays(int i, java.nio.IntBuffer intBuffer);

    void glDeleteVertexArrays(int i, int[] iArr, int i2);

    void glDrawArraysInstanced(int i, int i2, int i3, int i4);

    void glDrawBuffers(int i, java.nio.IntBuffer intBuffer);
    ...
    void glDrawRangeElements(int i, int i2, int i3, int i4, int i5, java.nio.Buffer buffer);
    ...
    void glGenQueries(int i, java.nio.IntBuffer intBuffer);

    void glGenQueries(int i, int[] iArr, int i2);

    void glGenSamplers(int i, java.nio.IntBuffer intBuffer);

    void glGenSamplers(int i, int[] iArr, int i2);

    void glGenTransformFeedbacks(int i, java.nio.IntBuffer intBuffer);

    void glGenTransformFeedbacks(int i, int[] iArr, int i2);

    void glGenVertexArrays(int i, java.nio.IntBuffer intBuffer);

    void glGenVertexArrays(int i, int[] iArr, int i2);

    java.lang.String glGetActiveUniformBlockName(int i, int i2);

    void glGetActiveUniformBlockName(int i, int i2, java.nio.Buffer buffer, java.nio.Buffer buffer2);

    void glGetActiveUniformBlockiv(int i, int i2, int i3, java.nio.IntBuffer intBuffer);

    void glGetActiveUniformsiv(int i, int i2, java.nio.IntBuffer intBuffer, int i3, java.nio.IntBuffer intBuffer2);

    void glGetBufferParameteri64v(int i, int i2, java.nio.LongBuffer longBuffer);

    java.nio.Buffer glGetBufferPointerv(int i, int i2);

    int glGetFragDataLocation(int i, java.lang.String str);

    void glGetInteger64v(int i, java.nio.LongBuffer longBuffer);

    void glGetQueryObjectuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetQueryiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetSamplerParameterfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glGetSamplerParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    java.lang.String glGetStringi(int i, int i2);

    int glGetUniformBlockIndex(int i, java.lang.String str);

    void glGetUniformIndices(int i, java.lang.String[] strArr, java.nio.IntBuffer intBuffer);

    void glGetUniformuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetVertexAttribIiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetVertexAttribIuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glInvalidateFramebuffer(int i, int i2, java.nio.IntBuffer intBuffer);

    void glInvalidateSubFramebuffer(int i, int i2, java.nio.IntBuffer intBuffer, int i3, int i4, int i5, int i6);
    ...
    void glSamplerParameterfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glSamplerParameteri(int i, int i2, int i3);

    void glSamplerParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glTexImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10);

    void glTexImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, java.nio.Buffer buffer);

    void glTexSubImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11);

    void glTexSubImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, java.nio.Buffer buffer);

    void glTransformFeedbackVaryings(int i, java.lang.String[] strArr, int i2);

    void glUniform1uiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glUniform3uiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glUniform4uiv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glUniformBlockBinding(int i, int i2, int i3);

    void glUniformMatrix2x3fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    void glUniformMatrix2x4fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    void glUniformMatrix3x2fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    void glUniformMatrix3x4fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    void glUniformMatrix4x2fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    void glUniformMatrix4x3fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);
