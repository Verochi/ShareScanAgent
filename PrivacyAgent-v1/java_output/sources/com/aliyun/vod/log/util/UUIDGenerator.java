...
public class UUIDGenerator {
    ...
    /* renamed from: com.aliyun.vod.log.util.UUIDGenerator$1, reason: invalid class name */
        ...
        */
        public void run() {
            ...
            if (!this.val$uuidFile.exists() && !this.val$uuidFile.createNewFile()) {
                ...
                properties.setProperty(com.aliyun.vod.log.util.UUIDGenerator.UUID_PROP, this.val$uuidValue);
                if (z) {
                ...
                com.aliyun.vod.log.util.UUIDGenerator.access$008();
                if (!z2 || com.aliyun.vod.log.util.UUIDGenerator.sWriteUUIDCount >= 10) {
                }
                com.aliyun.vod.log.util.UUIDGenerator.writeUUIDToFile(this.val$uuidFile, this.val$uuidValue);
                return;
            }
            z = true;
            java.util.Properties properties2 = new java.util.Properties();
            properties2.setProperty(com.aliyun.vod.log.util.UUIDGenerator.UUID_PROP, this.val$uuidValue);
            if (z) {
            }
            com.aliyun.vod.log.util.UUIDGenerator.access$008();
            if (z2) {
    ...
    public static final java.lang.String generateRequestID() {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static synchronized java.lang.String generateUUID() {
        boolean z;
        synchronized (com.aliyun.vod.log.util.UUIDGenerator.class) {
    ...
    public static void writeUUIDToFile(java.io.File file, java.lang.String str) {
        ...
        new java.util.Timer().schedule(new com.aliyun.vod.log.util.UUIDGenerator.AnonymousClass1(file, str), 3000L);
    }
}
