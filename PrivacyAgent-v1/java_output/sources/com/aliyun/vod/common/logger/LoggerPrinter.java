...
public final class LoggerPrinter implements com.aliyun.vod.common.logger.Printer {
    ...
    private com.aliyun.vod.common.logger.Settings settings;
    ...
    private int getStackOffset(java.lang.StackTraceElement[] stackTraceElementArr) {
        for (int i = 3; i < stackTraceElementArr.length; i++) {
            ...
            if (!className.equals(com.aliyun.vod.common.logger.LoggerPrinter.class.getName()) && !className.equals(com.aliyun.vod.common.logger.Logger.class.getName())) {
                return i - 1;
            }
        }
        return -1;
    ...
    private synchronized void log(int i, java.lang.String str, java.lang.Object... objArr) {
        if (this.settings.getLogLevel() == com.aliyun.vod.common.logger.LogLevel.NONE) {
            return;
        }
    ...
    @Override // com.aliyun.vod.common.logger.Printer
    public com.aliyun.vod.common.logger.Settings getSettings() {
    ...
    public com.aliyun.vod.common.logger.Settings init(java.lang.String str) {
        if (str == null) {
        ...
        this.tag = str;
        com.aliyun.vod.common.logger.Settings settings = new com.aliyun.vod.common.logger.Settings();
    ...
    @Override // com.aliyun.vod.common.logger.Printer
    public com.aliyun.vod.common.logger.Printer t(java.lang.String str, int i) {
        if (str != null) {
