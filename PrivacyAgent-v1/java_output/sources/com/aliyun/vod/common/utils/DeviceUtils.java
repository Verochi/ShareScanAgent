...
public class DeviceUtils {
    ...
    /* renamed from: com.aliyun.vod.common.utils.DeviceUtils$1, reason: invalid class name */
    ...
    public static java.lang.String getUDID(android.content.Context context) {
        ...
        if (com.aliyun.vod.common.utils.StringUtils.isEmpty(string) || string.equals("9774d56d682e549c") || string.length() < 15) {
            string = new java.math.BigInteger(64, new java.security.SecureRandom()).toString(16);
        }
        return com.aliyun.vod.common.utils.StringUtils.isEmpty(string) ? "" : string;
    }
    ...
    public boolean isSoftKeyAvail(android.app.Activity activity) {
        ...
        findViewById.getViewTreeObserver().addOnGlobalLayoutListener(new com.aliyun.vod.common.utils.DeviceUtils.AnonymousClass1(findViewById, zArr));
        return zArr[0];
    }
}
