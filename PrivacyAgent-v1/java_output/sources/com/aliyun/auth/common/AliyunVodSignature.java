...
public class AliyunVodSignature {
    ...
    public static java.lang.String getCQS(java.util.List<java.lang.String> list) {
        java.util.Collections.sort(list, new com.aliyun.auth.common.AliyunVodSignature.ParamsComparator());
    ...
    public static java.lang.String newStringByBase64(byte[] bArr) throws java.io.UnsupportedEncodingException {
        ...
        return new java.lang.String(com.aliyun.auth.common.Base64Coder.encode(bArr, 2));
    }
