...
public class CommonUtil {
    ...
    /* renamed from: com.aliyun.common.utils.CommonUtil$1, reason: invalid class name */
    public static class AnonymousClass1 implements android.app.Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(android.app.Activity activity, android.os.Bundle bundle) {
            activity.getWindow().getDecorView().getRootView().getViewTreeObserver().addOnGlobalFocusChangeListener(new com.aliyun.common.utils.CommonUtil.ReferenceCleaner(this.val$inputMethodManager, this.val$mHField, this.val$mServedViewField, this.val$finishInputLockedMethod));
        }
    ...
    public static void fixFocusedViewLeak(android.app.Application application) {
        ...
        try {
            ...
            application.registerActivityLifecycleCallbacks(new com.aliyun.common.utils.CommonUtil.AnonymousClass1(inputMethodManager, declaredField2, declaredField, declaredMethod));
        } catch (java.lang.Exception unused) {
        }
    }
