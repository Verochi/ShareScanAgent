...
public class AliyunLogEvent {
    public static final int EVENT_ADD_ANIMATION_FILTER = 3019;
    public static final int EVENT_ADD_FILTER = 2009;
    public static final int EVENT_ADD_FRAME_ANIMATION = 3020;
    ...
    public static final int EVENT_ADD_RUNNING_DISPLAY_MODE = 3022;
    public static final int EVENT_ADD_STATIC_IMAGE = 3021;
    public static final int EVENT_ADD_VIDEO = 9001;
    public static final int EVENT_APPLY_BLUR_BACKGROUND = 3023;
    public static final int EVENT_APPLY_DUB = 3018;
    ...
    public static final int EVENT_APPLY_SOURCE_CHANGE = 3024;
    ...
    public static final int EVENT_DENOISE = 3025;
    ...
    public static final int EVENT_INVERT = 3026;
    ...
    public static final int EVENT_PLAY_ERROR = 4012;
    public static final int EVENT_RATE = 3027;
    public static final int EVENT_RECORDING_FAILED = 2006;
    public static final int EVENT_RECORD_APPLY_MV = 2014;
    public static final int EVENT_REPEAT = 3028;
    ...
    public static final int EVENT_SET_TRANSITION = 3029;
