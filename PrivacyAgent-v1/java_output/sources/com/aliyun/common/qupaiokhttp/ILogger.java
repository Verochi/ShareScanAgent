...
public class ILogger {
    ...
    private static com.aliyun.common.logger.LoggerPrinter printer;

    private ILogger() {
        printer = com.aliyun.common.logger.LoggerFactory.getFactory("OkHttpFinal", DEBUG);
    }
    ...
    private static void createInstance() {
        if (printer == null) {
            new com.aliyun.common.qupaiokhttp.ILogger();
        }
    }
    ...
    public static com.aliyun.common.logger.Settings getSettings() {
        createInstance();
    ...
    public static com.aliyun.common.logger.Printer t(int i) {
        createInstance();
        return printer.t(null, i);
    }

    public static com.aliyun.common.logger.Printer t(java.lang.String str) {
        createInstance();
        com.aliyun.common.logger.LoggerPrinter loggerPrinter = printer;
        return loggerPrinter.t(str, loggerPrinter.getSettings().getMethodCount());
    }

    public static com.aliyun.common.logger.Printer t(java.lang.String str, int i) {
        createInstance();
