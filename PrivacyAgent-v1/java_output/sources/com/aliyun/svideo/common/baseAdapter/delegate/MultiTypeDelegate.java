...
public abstract class MultiTypeDelegate<T> {
    ...
    public com.aliyun.svideo.common.baseAdapter.delegate.MultiTypeDelegate registerItemType(int i, @androidx.annotation.LayoutRes int i2) {
        this.selfMode = true;
    ...
    public com.aliyun.svideo.common.baseAdapter.delegate.MultiTypeDelegate registerItemTypeAutoIncrease(@androidx.annotation.LayoutRes int... iArr) {
        this.autoMode = true;
