...
public final class AlivcCommonDialogAlertCustomBinding implements androidx.viewbinding.ViewBinding {
    ...
    @androidx.annotation.NonNull
    public static com.aliyun.svideo.common.databinding.AlivcCommonDialogAlertCustomBinding bind(@androidx.annotation.NonNull android.view.View view) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            return new com.aliyun.svideo.common.databinding.AlivcCommonDialogAlertCustomBinding(view, linearLayout, imageView, textView, textView2, textView3);
                        }
                    }
                }
            }
    ...
    @androidx.annotation.NonNull
    public static com.aliyun.svideo.common.databinding.AlivcCommonDialogAlertCustomBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.NonNull android.view.ViewGroup viewGroup) {
        if (viewGroup == null) {
            throw new java.lang.NullPointerException("parent");
        }
        layoutInflater.inflate(com.aliyun.svideo.common.R.layout.alivc_common_dialog_alert_custom, viewGroup);
