...
public class ZipUtils {
    ...
    private static final java.lang.String CHINESE_CHARSET = "GBK";

    public static void unZip(java.lang.String str, java.lang.String str2) throws java.lang.Exception {
        org.apache.tools.zip.ZipFile zipFile = new org.apache.tools.zip.ZipFile(str, CHINESE_CHARSET);
        ...
        while (entries.hasMoreElements()) {
            ...
            java.lang.String substring = nextElement.getName().substring(nextElement.getName().lastIndexOf(net.lingala.zip4j.util.InternalZipConstants.ZIP_FILE_SEPARATOR), nextElement.getName().length());
    ...
    public static void zip(java.lang.String str, java.lang.String str2) throws java.lang.Exception {
        ...
        org.apache.tools.zip.ZipOutputStream zipOutputStream = new org.apache.tools.zip.ZipOutputStream(bufferedOutputStream);
    ...
    private static void zipFile(java.io.File file, java.lang.String str, org.apache.tools.zip.ZipOutputStream zipOutputStream) throws java.lang.Exception {
        byte[] bArr = new byte[1024];
        for (java.io.File file2 : file.isDirectory() ? file.listFiles() : new java.io.File[]{file}) {
            if (file2.isDirectory()) {
                zipOutputStream.putNextEntry(new org.apache.tools.zip.ZipEntry(file2.getPath().substring(str.length() + 1) + net.lingala.zip4j.util.InternalZipConstants.ZIP_FILE_SEPARATOR));
                ...
                zipOutputStream.putNextEntry(new org.apache.tools.zip.ZipEntry(substring));
                while (true) {
                    int read = bufferedInputStream.read(bArr, 0, 1024);
                    if (read == -1) {
                        break;
