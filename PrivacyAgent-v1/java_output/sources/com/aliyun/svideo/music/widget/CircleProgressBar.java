...
public class CircleProgressBar extends android.view.View {
    ...
    public CircleProgressBar(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
        ...
        android.content.res.TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar);
        this.mBackgroundWidth = obtainStyledAttributes.getDimension(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicBackgroundWidth, this.mBackgroundWidth);
        this.mBackgroundHeight = obtainStyledAttributes.getDimension(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicBackgroundHeight, this.mBackgroundHeight);
        this.mProgressWidth = obtainStyledAttributes.getDimension(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicProgressWidth, this.mProgressWidth);
        this.mProgressThickness = obtainStyledAttributes.getDimension(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicProgressThickness, this.mProgressThickness);
        this.mBackgroundColor = obtainStyledAttributes.getColor(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicBackgroundColor, this.mBackgroundColor);
        this.mProgressColor = obtainStyledAttributes.getColor(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicProgressColor, this.mProgressColor);
        this.progressThicknessColor = obtainStyledAttributes.getColor(com.aliyun.svideo.music.R.styleable.MusicCircleProgressBar_musicProgressThicknessColor, this.progressThicknessColor);
