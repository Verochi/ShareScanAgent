...
public class IMVForm implements java.io.Serializable {
    private java.util.List<com.aliyun.svideo.base.Form.AspectForm> aspectList;
    private int cat;
    ...
    public java.util.List<com.aliyun.svideo.base.Form.AspectForm> getAspectList() {
    ...
    public void setAspectList(java.util.List<com.aliyun.svideo.base.Form.AspectForm> list) {
