...
public class MusicHorizontalScrollView extends android.widget.HorizontalScrollView {
    private com.aliyun.svideo.base.widget.MusicHorizontalScrollView.ScrollViewListener scrollViewListener;
    ...
    public void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        com.aliyun.svideo.base.widget.MusicHorizontalScrollView.ScrollViewListener scrollViewListener = this.scrollViewListener;
    ...
    public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        com.aliyun.svideo.base.widget.MusicHorizontalScrollView.ScrollViewListener scrollViewListener;
    ...
    public void setScrollViewListener(com.aliyun.svideo.base.widget.MusicHorizontalScrollView.ScrollViewListener scrollViewListener) {
