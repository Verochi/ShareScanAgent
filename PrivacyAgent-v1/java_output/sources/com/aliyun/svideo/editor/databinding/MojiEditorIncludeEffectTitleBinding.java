...
public final class MojiEditorIncludeEffectTitleBinding implements androidx.viewbinding.ViewBinding {
    ...
    @androidx.annotation.NonNull
    public static com.aliyun.svideo.editor.databinding.MojiEditorIncludeEffectTitleBinding bind(@androidx.annotation.NonNull android.view.View view) {
        ...
        if (imageView != null) {
            ...
            if (imageView2 != null) {
                ...
                if (imageView3 != null) {
                    ...
                    if (textView != null) {
                        return new com.aliyun.svideo.editor.databinding.MojiEditorIncludeEffectTitleBinding(view, imageView, imageView2, imageView3, textView);
                    }
                }
            }
        }
    ...
    @androidx.annotation.NonNull
    public static com.aliyun.svideo.editor.databinding.MojiEditorIncludeEffectTitleBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.NonNull android.view.ViewGroup viewGroup) {
        if (viewGroup == null) {
            throw new java.lang.NullPointerException("parent");
        }
        layoutInflater.inflate(com.aliyun.svideo.editor.R.layout.moji_editor_include_effect_title, viewGroup);
