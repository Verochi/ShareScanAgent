...
public class MoreAnimationEffectAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder> {
    private static final java.lang.String TAG = "com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter";
    ...
    private java.util.Comparator<com.aliyun.svideo.editor.effectmanager.EffectBody<com.aliyun.svideo.base.Form.AnimationEffectForm>> mMVCompator = new com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.AnimationFilterFormCompator();
    private com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.OnItemRightButtonClickListener mRightBtnClickListener;
    ...
    public class ImvViewHolder extends androidx.recyclerview.widget.RecyclerView.ViewHolder {
        ...
        /* renamed from: com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter$ImvViewHolder$1, reason: invalid class name */
        public class AnonymousClass1 implements android.view.View.OnClickListener {
            final /* synthetic */ com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter val$this$0;

            public AnonymousClass1(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter moreAnimationEffectAdapter) {
                this.val$this$0 = moreAnimationEffectAdapter;
            }

            @Override // android.view.View.OnClickListener
            @com.sensorsdata.analytics.android.sdk.SensorsDataInstrumented
            public void onClick(android.view.View view) {
                if (com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this.mRightBtnClickListener != null) {
                    if (com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData.isLocal()) {
                        com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this.mRightBtnClickListener.onLocalItemClick(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mPosition, com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData);
                    } else {
                        com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this.mRightBtnClickListener.onRemoteItemClick(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mPosition, com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData);
                    }
                }
        ...
        /* renamed from: com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter$ImvViewHolder$2, reason: invalid class name */
        public class AnonymousClass2 implements android.view.View.OnClickListener {
            final /* synthetic */ com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter val$this$0;

            public AnonymousClass2(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter moreAnimationEffectAdapter) {
                this.val$this$0 = moreAnimationEffectAdapter;
            }
        ...
        /* renamed from: com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter$ImvViewHolder$3, reason: invalid class name */
        public class AnonymousClass3 implements android.view.View.OnClickListener {
            final /* synthetic */ com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter val$this$0;

            public AnonymousClass3(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter moreAnimationEffectAdapter) {
                this.val$this$0 = moreAnimationEffectAdapter;
            }
            ...
            @com.sensorsdata.analytics.android.sdk.SensorsDataInstrumented
            public void onClick(android.view.View view) {
                if (((com.aliyun.svideo.base.Form.AnimationEffectForm) com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData.getData()).getPreviewMediaUrl() != null && !"".equals(((com.aliyun.svideo.base.Form.AnimationEffectForm) com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData.getData()).getPreviewMediaUrl())) {
                    com.aliyun.svideo.editor.effects.imv.IMVPreviewDialog.newInstance(((com.aliyun.svideo.base.Form.AnimationEffectForm) com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData.getData()).getPreviewMediaUrl(), ((com.aliyun.svideo.base.Form.AnimationEffectForm) com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.this.mData.getData()).getPreviewImageUrl()).show(((com.aliyun.svideo.editor.effectmanager.MoreMVActivity) com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this.mContext).getSupportFragmentManager(), "iMV");
                }
                com.sensorsdata.analytics.android.autotrack.aop.SensorsDataAutoTrackHelper.trackViewOnClick(view);
            }
        }
        ...
        public ImvViewHolder(android.view.View view) {
            ...
            textView.setText(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this.mContext.getResources().getString(com.aliyun.svideo.editor.R.string.alivc_common_download));
            this.mTvRightButton.setOnClickListener(new com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.AnonymousClass1(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this));
            this.downloadFinish.setOnClickListener(new com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.AnonymousClass2(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this));
            view.setOnClickListener(new com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder.AnonymousClass3(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this));
        }
        ...
        public void updateData(int i, com.aliyun.svideo.editor.effectmanager.EffectBody<com.aliyun.svideo.base.Form.AnimationEffectForm> effectBody) {
            ...
            if (!com.aliyun.svideo.common.utils.LanguageUtils.isCHEN(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.this.mContext) && data.getNameEn() != null) {
                name = data.getNameEn();
            }
    ...
    public MoreAnimationEffectAdapter(android.content.Context context) {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder imvViewHolder, int i) {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder onCreateViewHolder(android.view.ViewGroup viewGroup, int i) {
        return new com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder(android.view.LayoutInflater.from(viewGroup.getContext()).inflate(com.aliyun.svideo.editor.R.layout.alivc_editor_item_more_effect, viewGroup, false));
    }

    public void setRightBtnClickListener(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.OnItemRightButtonClickListener onItemRightButtonClickListener) {
    ...
    public void updateProcess(com.aliyun.svideo.editor.effectmanager.MoreAnimationEffectAdapter.ImvViewHolder imvViewHolder, int i, int i2) {
