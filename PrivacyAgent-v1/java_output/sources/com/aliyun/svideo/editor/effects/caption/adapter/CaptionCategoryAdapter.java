...
public class CaptionCategoryAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
    private static final int VIEW_TYPE_SELECTED = 1;
    private static final int VIEW_TYPE_UNSELECTED = 2;
    private com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.OnItemClickListener mItemClick;
    private java.util.List<com.aliyun.svideo.downloader.FileDownloaderModel> mData = new java.util.ArrayList();
    private int mSelectedPosition = 0;

    /* renamed from: com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter$1, reason: invalid class name */
    public class AnonymousClass1 implements android.view.View.OnClickListener {
        ...
        public void onClick(android.view.View view) {
            ...
            com.aliyun.svideo.downloader.FileDownloaderModel fileDownloaderModel = (com.aliyun.svideo.downloader.FileDownloaderModel) com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mData.get(adapterPosition);
            if (fileDownloaderModel == null) {
                if (com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mItemClick != null) {
                    com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mItemClick.onItemClick(fileDownloaderModel);
                }
            } else if (fileDownloaderModel.getCategory() == -1) {
                if (com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mItemClick != null) {
                    com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mItemClick.onMoreClick();
                }
            } else if (com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mItemClick != null) {
                com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.mItemClick.onItemClick(fileDownloaderModel);
            }
            com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.this.selectPosition(adapterPosition);
    ...
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, int i) {
        com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.CategoryViewHolder categoryViewHolder = (com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.CategoryViewHolder) viewHolder;
        ...
        categoryViewHolder.itemView.setOnClickListener(new com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.AnonymousClass1(viewHolder));
        if (itemViewType == 1) {
    ...
    public androidx.recyclerview.widget.RecyclerView.ViewHolder onCreateViewHolder(android.view.ViewGroup viewGroup, int i) {
        return new com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.CategoryViewHolder(android.view.LayoutInflater.from(viewGroup.getContext()).inflate(com.aliyun.svideo.editor.R.layout.alivc_editor_item_category, viewGroup, false));
    }
    ...
    public void setOnItemClickListener(com.aliyun.svideo.editor.effects.caption.adapter.CaptionCategoryAdapter.OnItemClickListener onItemClickListener) {
