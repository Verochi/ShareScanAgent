...
public class RollCaptionAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> implements android.view.View.OnClickListener {
    ...
    /* renamed from: com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter$1, reason: invalid class name */
    public class AnonymousClass1 extends com.aliyun.svideo.common.utils.image.AbstractImageLoaderTarget<android.graphics.drawable.Drawable> {
        final /* synthetic */ com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder val$captionViewHolder;

        public AnonymousClass1(com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder captionViewHolder) {
    ...
    /* renamed from: com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter$2, reason: invalid class name */
    public class AnonymousClass2 extends com.aliyun.svideo.downloader.FileDownloaderCallback {
        ...
        public void onFinish(int i, java.lang.String str) {
            ...
            if (com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.mItemClick != null) {
                ...
                source.setId(java.lang.String.valueOf(this.val$form.getId()));
                effectInfo.setSource(source);
                java.lang.String pathByUrl = com.aliyun.svideo.downloader.DownloaderManager.getInstance().getDbController().getPathByUrl(com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.getFontByPaster(this.val$form).getUrl());
                if (!com.aliyun.common.utils.StringUtils.isEmpty(pathByUrl)) {
                    com.aliyun.svideosdk.common.struct.project.Source source2 = new com.aliyun.svideosdk.common.struct.project.Source(pathByUrl);
                    effectInfo.fontSource = source2;
                    source2.setId(java.lang.String.valueOf(this.val$form.getFontId()));
                    effectInfo.fontSource.setURL(com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.getFontByPaster(this.val$form).getUrl());
                }
                com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.mItemClick.onItemClick(effectInfo, this.val$index);
            }
        }
    ...
    /* renamed from: com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter$3, reason: invalid class name */
    public class AnonymousClass3 extends com.aliyun.common.qupaiokhttp.StringHttpRequestCallback {
        ...
        public void onSuccess(java.lang.String str) {
            ...
            super.onSuccess((com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.AnonymousClass3) str);
            try {
            ...
            if (fontForm != null) {
                if (!com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.ids.contains(java.lang.Integer.valueOf(fontForm.getId()))) {
                    com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.fontData.add(fontForm);
                    com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.ids.add(java.lang.Integer.valueOf(fontForm.getId()));
                }
                com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.notifyDataSetChanged();
            }
        }
    }

    /* renamed from: com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter$4, reason: invalid class name */
    public class AnonymousClass4 extends com.aliyun.svideo.downloader.FileDownloaderCallback {
        ...
        public void onFinish(int i, java.lang.String str) {
            ...
            if (com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.mItemClick != null) {
                ...
                effectInfo.fontPath = str + com.aliyun.svideo.editor.contant.CaptionConfig.FONT_NAME;
                com.aliyun.svideosdk.common.struct.project.Source source = new com.aliyun.svideosdk.common.struct.project.Source(str + com.aliyun.svideo.editor.contant.CaptionConfig.FONT_NAME);
                effectInfo.fontSource = source;
                source.setId(java.lang.String.valueOf(this.val$form.getId()));
                effectInfo.fontSource.setURL(this.val$form.getUrl());
                com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.this.mItemClick.onItemClick(effectInfo, this.val$index);
            }
        }
    ...
    public RollCaptionAdapter(android.content.Context context) {
    ...
    private void downloadFont(com.aliyun.svideosdk.common.struct.form.FontForm fontForm, int i) {
        ...
        com.aliyun.svideo.downloader.DownloaderManager.getInstance().startTask(com.aliyun.svideo.downloader.DownloaderManager.getInstance().addTask(fileDownloaderModel, fileDownloaderModel.getUrl()).getTaskId(), new com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.AnonymousClass4(fontForm, i));
    }
    ...
    private void downloadPaster(com.aliyun.svideo.base.Form.PasterForm pasterForm, int i) {
        ...
        fileDownloaderModel.setIsunzip(1);
        com.aliyun.svideo.downloader.DownloaderManager.getInstance().startTask(com.aliyun.svideo.downloader.DownloaderManager.getInstance().addTask(fileDownloaderModel, fileDownloaderModel.getUrl()).getTaskId(), new com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.AnonymousClass2(pasterForm, i));
    }
    ...
    private void getFont(int i) {
        ...
        sb.append(str);
        sb.append(str2);
        com.aliyun.common.qupaiokhttp.HttpRequest.get(sb.toString(), new com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.AnonymousClass3());
    }
    ...
    private void getFontFromLocal() {
        ...
        try {
            for (java.lang.String str : this.mContext.getAssets().list("font")) {
                com.aliyun.svideosdk.common.struct.form.FontForm fontForm3 = new com.aliyun.svideosdk.common.struct.form.FontForm();
                if ("Pangtouyu.ttf".equals(str)) {
                    fontForm3.setIcon("R.mipmap.aliyun_svideo_pty_font_icon");
                } else {
                    fontForm3.setIcon("R.mipmap.aliyun_svideo_xk_font_icon");
                }
                fontForm3.setUrl(com.aliyun.svideo.editor.util.EditorCommon.SD_DIR + "font" + java.io.File.separator + str);
                java.util.concurrent.CopyOnWriteArrayList<com.aliyun.svideosdk.common.struct.form.FontForm> copyOnWriteArrayList = this.fontData;
                copyOnWriteArrayList.add(copyOnWriteArrayList.size(), fontForm3);
            }
    ...
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, int i) {
        com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder captionViewHolder = (com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder) viewHolder;
        ...
        } else if (!icon.startsWith("R")) {
            new com.aliyun.svideo.common.utils.image.ImageLoaderImpl().loadImage(this.mContext, icon).into(captionViewHolder.mImage, new com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.AnonymousClass1(captionViewHolder));
        } else if (icon.contains("pty")) {
            captionViewHolder.mImage.setImageResource(com.aliyun.svideo.editor.R.mipmap.aliyun_svideo_pty_font_icon);
        } else {
            captionViewHolder.mImage.setImageResource(com.aliyun.svideo.editor.R.mipmap.aliyun_svideo_xk_font_icon);
        }
    ...
    public void onClick(android.view.View view) {
        int adapterPosition = ((com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder) view.getTag()).getAdapterPosition();
        ...
        if (itemViewType == 6) {
            ...
            if (pathByUrl == null || pathByUrl.isEmpty()) {
                ...
                if (fontByPaster == null) {
                    ...
                    com.aliyun.svideosdk.common.struct.project.Source source2 = new com.aliyun.svideosdk.common.struct.project.Source(com.aliyun.svideo.downloader.DownloaderManager.getInstance().getDbController().getPathByUrl(fontByPaster.getUrl()));
                    effectInfo.fontSource = source2;
                    source2.setId(java.lang.String.valueOf(pasterForm.getFontId()));
                    effectInfo.fontSource.setURL(fontByPaster.getUrl());
                }
            ...
            if (!"system_font".equals(fontForm.getIcon())) {
                java.lang.String pathByUrl2 = com.aliyun.svideo.downloader.DownloaderManager.getInstance().getDbController().getPathByUrl(fontForm.getUrl());
                if (pathByUrl2 == null || pathByUrl2.isEmpty()) {
                    ...
                    effectInfo2.setSource(null);
                    effectInfo2.fontPath = pathByUrl2 + com.aliyun.svideo.editor.contant.CaptionConfig.FONT_NAME;
                    com.aliyun.svideosdk.common.struct.project.Source source3 = new com.aliyun.svideosdk.common.struct.project.Source(pathByUrl2 + com.aliyun.svideo.editor.contant.CaptionConfig.FONT_NAME);
                    effectInfo2.fontSource = source3;
                    source3.setId(java.lang.String.valueOf(fontForm.getId()));
                    effectInfo2.fontSource.setURL(fontForm.getUrl());
                ...
                effectInfo3.setSource(null);
                effectInfo3.fontPath = "system_font";
                effectInfo3.fontSource = new com.aliyun.svideosdk.common.struct.project.Source("system_font");
    ...
    public androidx.recyclerview.widget.RecyclerView.ViewHolder onCreateViewHolder(android.view.ViewGroup viewGroup, int i) {
        ...
        com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder captionViewHolder = new com.aliyun.svideo.editor.effects.rollcaption.RollCaptionAdapter.CaptionViewHolder(inflate);
