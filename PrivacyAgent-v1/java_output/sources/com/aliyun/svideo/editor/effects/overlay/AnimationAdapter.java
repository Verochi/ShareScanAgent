...
public class AnimationAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
    private android.content.Context mContext;
    private com.aliyun.svideo.editor.effects.overlay.AnimationDialog.OnItemClickListener mOnItemClickListerner;
    ...
    public class TransitionViewEffectHolder extends androidx.recyclerview.widget.RecyclerView.ViewHolder {
        ...
        /* renamed from: com.aliyun.svideo.editor.effects.overlay.AnimationAdapter$TransitionViewEffectHolder$1, reason: invalid class name */
        public class AnonymousClass1 implements android.view.View.OnClickListener {
            final /* synthetic */ com.aliyun.svideo.editor.effects.overlay.AnimationAdapter val$this$0;

            public AnonymousClass1(com.aliyun.svideo.editor.effects.overlay.AnimationAdapter animationAdapter) {
                this.val$this$0 = animationAdapter;
            }

            @Override // android.view.View.OnClickListener
            @com.sensorsdata.analytics.android.sdk.SensorsDataInstrumented
            public void onClick(android.view.View view) {
                if (com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.this.mOnItemClickListerner != null) {
                    com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.this.mOnItemClickListerner.onItemClick(com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder.this.getAdapterPosition());
                    com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder transitionViewEffectHolder = com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder.this;
                    com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.this.mSelectPosition = transitionViewEffectHolder.getAdapterPosition();
                    com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.this.notifyDataSetChanged();
                }
        ...
        public TransitionViewEffectHolder(android.view.View view) {
            ...
            imageView.setOnClickListener(new com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder.AnonymousClass1(com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.this));
            this.mEffectName = (android.widget.TextView) view.findViewById(com.aliyun.svideo.editor.R.id.tv_effect_name);
        }
    }

    public AnimationAdapter(android.content.Context context) {
        this.mContext = context;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return com.aliyun.svideo.editor.effects.overlay.AnimationDialog.POSITION_FONT_ANIM_ARRAY.length;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, int i) {
        com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder transitionViewEffectHolder = (com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder) viewHolder;
        switch (i) {
            case 0:
    ...
    public androidx.recyclerview.widget.RecyclerView.ViewHolder onCreateViewHolder(android.view.ViewGroup viewGroup, int i) {
        return new com.aliyun.svideo.editor.effects.overlay.AnimationAdapter.TransitionViewEffectHolder(((com.aliyun.svideo.editor.editor.EditorActivity) this.mContext).getLayoutInflater().inflate(com.aliyun.svideo.editor.R.layout.alivc_editor_item_transition_effect, (android.view.ViewGroup) null));
    }

    public void setOnItemClickListener(com.aliyun.svideo.editor.effects.overlay.AnimationDialog.OnItemClickListener onItemClickListener) {
