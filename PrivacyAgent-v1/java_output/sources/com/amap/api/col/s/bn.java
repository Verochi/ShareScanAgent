...
public final class bn {
    ...
    public static java.lang.String a(java.lang.String str) {
        return com.amap.api.col.s.bu.a(b(str));
    }
    ...
    public static byte[] a(byte[] bArr) throws java.security.cert.CertificateException, java.security.spec.InvalidKeySpecException, java.security.NoSuchAlgorithmException, java.lang.NullPointerException, java.io.IOException, java.security.InvalidKeyException, javax.crypto.NoSuchPaddingException, javax.crypto.IllegalBlockSizeException, javax.crypto.BadPaddingException {
        ...
        byte[] b2 = b(encoded, d);
        byte[] c = c(encoded, bArr);
        byte[] bArr2 = new byte[b2.length + c.length];
        java.lang.System.arraycopy(b2, 0, bArr2, 0, b2.length);
        java.lang.System.arraycopy(c, 0, bArr2, b2.length, c.length);
        return bArr2;
    }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, byte[] bArr3) throws java.lang.Exception {
        ...
        javax.crypto.spec.SecretKeySpec secretKeySpec = new javax.crypto.spec.SecretKeySpec(bArr, com.amap.api.col.s.bu.c("EQUVT"));
    ...
    public static java.lang.String b(byte[] bArr) {
        try {
            ...
            com.amap.api.col.s.cg.a(th, "er", "e64");
            return null;
        }
    }
    ...
    public static byte[] b(java.lang.String str) {
        ...
        byte[] a2 = com.amap.api.col.s.bu.a(str);
    ...
    public static byte[] b(byte[] bArr, java.security.Key key) throws java.security.NoSuchAlgorithmException, javax.crypto.NoSuchPaddingException, java.security.InvalidKeyException, javax.crypto.IllegalBlockSizeException, javax.crypto.BadPaddingException {
    ...
    public static byte[] c(byte[] bArr, byte[] bArr2) {
        try {
            return d(bArr, bArr2, com.amap.api.col.s.bu.c());
        } catch (java.lang.Throwable th) {
            com.amap.api.col.s.cg.a(th, "er", "asEn");
            return null;
        }
    }

    public static byte[] d(byte[] bArr, byte[] bArr2, byte[] bArr3) throws javax.crypto.NoSuchPaddingException, java.security.NoSuchAlgorithmException, java.security.InvalidKeyException, javax.crypto.BadPaddingException, javax.crypto.IllegalBlockSizeException {
        javax.crypto.spec.IvParameterSpec ivParameterSpec = new javax.crypto.spec.IvParameterSpec(bArr3);
        javax.crypto.spec.SecretKeySpec secretKeySpec = new javax.crypto.spec.SecretKeySpec(bArr, com.amap.api.col.s.bu.c("EQUVT"));
        javax.crypto.Cipher cipher = javax.crypto.Cipher.getInstance(com.amap.api.col.s.bu.c("CQUVTL0NCQy9QS0NTNVBhZGRpbmc"));
        try {
