...
public class bx {
    ...
    public static java.lang.String b(byte[] bArr, int i) throws java.io.IOException {
        if (bArr == null) {
        ...
        int i5 = 0;
        while (i4 < i3) {
            c(bArr, i4 + 0, 3, bArr2, i5);
            i4 += 3;
            i5 += 4;
        }
        if (i4 < i) {
            c(bArr, i4 + 0, i - i4, bArr2, i5);
            i5 += 4;
        }
        if (i5 <= i2 - 1) {
    ...
    public static byte[] d(java.lang.String str) throws java.io.IOException {
        byte[] bytes;
        ...
        byte[] e2 = e(bytes, bytes.length);
        if (e2.length >= 4 && 35615 == ((e2[0] & 255) | ((e2[1] << 8) & androidx.core.view.MotionEventCompat.ACTION_POINTER_INDEX_MASK))) {
            ...
            try {
                try {
                    ...
                    try {
                        byteArrayInputStream = new java.io.ByteArrayInputStream(e2);
                        try {
                            ...
                            e2 = byteArrayOutputStream2.toByteArray();
    ...
    public static byte[] e(byte[] bArr, int i) throws java.io.IOException {
        int i2;
        if (bArr == null) {
