...
public final class bu {
    public static final java.lang.String[] a = {"arm64-v8a", "x86_64"};
    public static final java.lang.String[] b = {"arm", "x86"};
    ...
    public static com.amap.api.col.s.bt a() throws com.amap.api.col.s.bh {
        return new com.amap.api.col.s.bt.a("collection", "1.0", "AMap_collection_1.0").a(new java.lang.String[]{"com.amap.api.collection"}).a();
    }
    ...
    public static java.lang.String a(long j, java.lang.String str) {
        try {
            ...
            com.amap.api.col.s.cg.a(th, "ut", "ctt");
            return null;
        }
    }
    ...
    */
    public static java.lang.String a(android.content.Context context) {
        ...
        if (android.os.Build.VERSION.SDK_INT < 28) {
            try {
                ...
                com.amap.api.col.s.cg.a(th, "ut", "gct");
            }
            if (android.os.Build.VERSION.SDK_INT >= 28) {
                try {
                    ...
                    if (!android.text.TextUtils.isEmpty(str) && java.util.Arrays.asList(a).contains(str)) {
                        java.lang.String str2 = context.getApplicationInfo().nativeLibraryDir;
                        if (!android.text.TextUtils.isEmpty(str2)) {
                            if (java.util.Arrays.asList(b).contains(str2.substring(str2.lastIndexOf(java.io.File.separator) + 1)) && (strArr = (java.lang.String[]) android.os.Build.class.getDeclaredField("SUPPORTED_32_BIT_ABIS").get(null)) != null && strArr.length > 0) {
                                str = strArr[0];
                            }
                        }
                    }
                } catch (java.lang.Throwable th2) {
                    com.amap.api.col.s.cg.a(th2, "ut", "gct_p");
                }
            }
    ...
    public static java.lang.String a(java.util.Map<java.lang.String, java.lang.String> map) {
        ...
        try {
            ...
            com.amap.api.col.s.cg.a(th, "ut", "abP");
        }
    ...
    public static java.util.Calendar a(java.lang.String str, java.lang.String str2) {
        try {
            ...
            com.amap.api.col.s.cg.a(e, "ut", "ctt");
            return null;
        }
    }
    ...
    public static void a(android.content.Context context, java.lang.String str, java.lang.String str2, org.json.JSONObject jSONObject) {
        ...
        java.lang.String e = com.amap.api.col.s.bi.e(context);
        java.lang.String a2 = com.amap.api.col.s.bq.a(e);
        java.lang.String a3 = com.amap.api.col.s.bi.a(context);
        try {
            ...
            if ("INVALID_USER_SCODE".equals(str3)) {
                ...
                if (a2.equals(string2) || a2.equals(string)) {
                ...
                if (string.length() > 0 && !a3.equals(string)) {
        ...
        i("SHA1Package:".concat(java.lang.String.valueOf(e)));
        i("key:".concat(java.lang.String.valueOf(a3)));
        i("csid:".concat(java.lang.String.valueOf(str)));
        i("gsid:".concat(java.lang.String.valueOf(str2)));
        i("json:" + jSONObject.toString());
    }
    ...
    public static void a(java.io.ByteArrayOutputStream byteArrayOutputStream, byte b2, byte[] bArr) {
        try {
            ...
            com.amap.api.col.s.cg.a(e, "ut", "wFie");
        }
    }
    ...
    public static void a(java.io.ByteArrayOutputStream byteArrayOutputStream, java.lang.String str) {
        if (android.text.TextUtils.isEmpty(str)) {
            try {
                ...
                com.amap.api.col.s.cg.a(e, "ut", "wsf");
                return;
            }
        }
    ...
    public static boolean a(android.content.Context context, java.lang.String str) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 23 && context.getApplicationInfo().targetSdkVersion >= 23) {
            try {
                ...
                com.amap.api.col.s.cg.a(th, "ut", "cpm");
            }
        }
        return true;
    }
    ...
    public static com.amap.api.col.s.bt b() throws com.amap.api.col.s.bh {
        return new com.amap.api.col.s.bt.a("co", "1.0.0", "AMap_co_1.0.0").a(new java.lang.String[]{"com.amap.co", "com.amap.opensdk.co", "com.amap.location"}).a();
    }
    ...
    public static java.lang.String b(java.lang.String str) {
        ...
        java.lang.String c2 = com.amap.api.col.s.bn.c(a(str));
        try {
            return ((char) ((c2.length() % 26) + 65)) + c2;
        } catch (java.lang.Throwable th) {
            com.amap.api.col.s.cg.a(th, "ut", "tsfb64");
            return "";
        }
    }
    ...
    public static byte[] b(byte[] bArr) {
        try {
            ...
            com.amap.api.col.s.cg.a(th, "ut", "gZp");
            return new byte[0];
        }
    }

    public static java.lang.String c(java.lang.String str) {
        return str.length() < 2 ? "" : com.amap.api.col.s.bn.a(str.substring(1));
    }
    ...
    public static byte[] c() {
        try {
            ...
            java.lang.String[] split2 = new java.lang.StringBuffer(new java.lang.String(com.amap.api.col.s.bn.b(new java.lang.String(bArr)))).reverse().toString().split(",");
            ...
            com.amap.api.col.s.cg.a(th, "ut", "gIV");
            return new byte[16];
        }
    }
    ...
    public static byte[] c(byte[] bArr) {
        ...
        if (bArr != null) {
            try {
                ...
                com.amap.api.col.s.cg.a(th, "ut", "zp2");
            }
            if (bArr.length != 0) {
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                com.amap.api.col.s.cg.a(th2, "ut", "zp1");
                            }
                            byteArrayOutputStream.close();
                        } catch (java.lang.Throwable th3) {
                            th = th3;
                            try {
                                com.amap.api.col.s.cg.a(th, "ut", "zp");
                                if (zipOutputStream != null) {
                                    try {
                                        zipOutputStream.close();
                                    } catch (java.lang.Throwable th4) {
                                        com.amap.api.col.s.cg.a(th4, "ut", "zp1");
                                    }
                                }
    ...
    public static java.security.PublicKey d() throws java.security.cert.CertificateException, java.security.spec.InvalidKeySpecException, java.security.NoSuchAlgorithmException, java.lang.NullPointerException, java.io.IOException {
        ...
        try {
            byteArrayInputStream = new java.io.ByteArrayInputStream(com.amap.api.col.s.bn.b(""));
        } catch (java.lang.Throwable unused) {
    ...
    public static java.lang.String f(byte[] bArr) {
        try {
            ...
            com.amap.api.col.s.cg.a(th, "ut", "h2s");
            return null;
        }
    }
    ...
    public static java.lang.String h(byte[] bArr) {
        try {
            ...
            com.amap.api.col.s.cg.a(th, "ut", "csb2h");
            return null;
        }
    }
    ...
    public static byte[] j(byte[] bArr) throws java.io.IOException, java.lang.Throwable {
        java.io.ByteArrayOutputStream byteArrayOutputStream;
