...
public final class fa {
    ...
    public static java.lang.String a(java.lang.String str) {
        return com.amap.api.mapcore.util.fi.a(b(str));
    }
    ...
    private static byte[] a(byte[] bArr, byte[] bArr2) {
        try {
            return c(bArr, bArr2, com.amap.api.mapcore.util.fi.c());
        } catch (java.lang.Throwable th) {
            com.amap.api.mapcore.util.ga.a(th, "er", "asEn");
            return null;
        }
    }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, byte[] bArr3) throws java.lang.Exception {
        ...
        javax.crypto.spec.SecretKeySpec secretKeySpec = new javax.crypto.spec.SecretKeySpec(bArr, com.amap.api.mapcore.util.fi.c("EQUVT"));
    ...
    public static java.lang.String b(byte[] bArr) {
        try {
            ...
            com.amap.api.mapcore.util.ga.a(th, "er", "e64");
            return null;
        }
    }
    ...
    public static byte[] b(java.lang.String str) {
        ...
        byte[] a2 = com.amap.api.mapcore.util.fi.a(str);
