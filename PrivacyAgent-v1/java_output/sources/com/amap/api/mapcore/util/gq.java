...
public final class gq {
    ...
    public gq(java.lang.String str) {
        this.c = com.amap.api.mapcore.util.fd.b(android.text.TextUtils.isDigitsOnly(str) ? "SPUtil" : str);
    }
    ...
    public static int a(android.content.Context context, java.lang.String str, java.lang.String str2, int i) {
        try {
            ...
            com.amap.api.mapcore.util.gd.c(th, com.anythink.expressad.foundation.d.d.r, "giv");
            return i;
        }
    }
    ...
    public static android.content.SharedPreferences.Editor a(android.content.Context context, java.lang.String str) {
        if (context != null) {
            try {
                ...
                com.amap.api.mapcore.util.ga.a(th, "sp", "ge");
            }
        }
        return null;
    }
    ...
    public static java.lang.String a(android.content.Context context, java.lang.String str, java.lang.String str2) {
        ...
        try {
            return com.amap.api.mapcore.util.fi.a(b(context, com.amap.api.mapcore.util.fi.e(context.getSharedPreferences(str, 0).getString(str2, ""))));
    ...
    public static void a(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3) {
        ...
        try {
            ...
            edit.putString(str2, com.amap.api.mapcore.util.fi.g(a(context, com.amap.api.mapcore.util.fi.a(str3))));
            a(edit);
        } catch (java.lang.Throwable unused) {
        }
    }
    ...
    public static void a(android.content.SharedPreferences.Editor editor) {
        ...
        try {
            ...
            com.amap.api.mapcore.util.ga.a(th, "sp", com.aliyun.common.log.struct.AliyunLogKey.KEY_CROP_MODE);
        }
    }
    ...
    public static void a(android.content.SharedPreferences.Editor editor, java.lang.String str) {
        if (editor != null) {
            try {
                ...
                com.amap.api.mapcore.util.ga.a(th, "sp", "rk");
            }
        }
    }
    ...
    public static void a(android.content.SharedPreferences.Editor editor, java.lang.String str, int i) {
        try {
            ...
            com.amap.api.mapcore.util.gd.c(th, com.anythink.expressad.foundation.d.d.r, "putPrefsInt");
        }
    }
    ...
    public static void a(android.content.SharedPreferences.Editor editor, java.lang.String str, long j) {
        ...
        try {
            ...
            com.amap.api.mapcore.util.gd.c(th, com.anythink.expressad.foundation.d.d.r, "plv");
        }
    }
    ...
    public static void a(android.content.SharedPreferences.Editor editor, java.lang.String str, java.lang.String str2) {
        if (editor != null) {
            try {
                ...
                com.amap.api.mapcore.util.ga.a(th, "sp", com.aliyun.vod.log.struct.AliyunLogKey.KEY_PART_SIZE);
            }
        }
    }
    ...
    public static void a(android.content.SharedPreferences.Editor editor, java.lang.String str, boolean z) {
        try {
            ...
            com.amap.api.mapcore.util.gd.c(th, com.anythink.expressad.foundation.d.d.r, "setPrefsStr");
        }
    }
    ...
    public static boolean a(android.content.Context context, java.lang.String str, java.lang.String str2, boolean z) {
        try {
            ...
            com.amap.api.mapcore.util.gd.c(th, com.anythink.expressad.foundation.d.d.r, "gbv");
            return z;
        }
    }
    ...
    private static byte[] a(android.content.Context context) {
        ...
        byte[] bytes = com.amap.api.mapcore.util.ev.f(context).getBytes();
        a = bytes;
        return bytes;
    }
    ...
    public static byte[] a(android.content.Context context, byte[] bArr) {
        try {
            return com.amap.api.mapcore.util.fa.b(a(context), bArr, b(context));
        } catch (java.lang.Throwable unused) {
            return new byte[0];
        }
    }
    ...
    public static java.lang.String b(android.content.Context context, java.lang.String str, java.lang.String str2, java.lang.String str3) {
        ...
        try {
            ...
            com.amap.api.mapcore.util.gd.c(th, com.anythink.expressad.foundation.d.d.r, "gsv");
            return str3;
        }
    }
    ...
    public static byte[] b(android.content.Context context, byte[] bArr) {
        try {
            return com.amap.api.mapcore.util.fa.a(a(context), bArr, b(context));
