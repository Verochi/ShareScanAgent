...
public final class gz implements java.io.Closeable {
    ...
    /* renamed from: com.amap.api.mapcore.util.gz$1, reason: invalid class name */
    public class AnonymousClass1 extends java.io.ByteArrayOutputStream {
        ...
        public final java.lang.String toString() {
            ...
            try {
                return new java.lang.String(((java.io.ByteArrayOutputStream) this).buf, 0, i, com.amap.api.mapcore.util.gz.this.c.name());
    ...
    public gz(java.io.InputStream inputStream, java.nio.charset.Charset charset) {
        this(inputStream, charset, (byte) 0);
    }

    private gz(java.io.InputStream inputStream, java.nio.charset.Charset charset, byte b) {
    ...
    public final java.lang.String a() throws java.io.IOException {
        ...
        synchronized (this.b) {
            ...
            com.amap.api.mapcore.util.gz.AnonymousClass1 anonymousClass1 = new com.amap.api.mapcore.util.gz.AnonymousClass1((this.f - this.e) + 80);
            loop1: while (true) {
                byte[] bArr3 = this.d;
                int i5 = this.e;
