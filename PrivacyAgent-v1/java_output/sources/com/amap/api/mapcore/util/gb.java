...
public final class gb {
    ...
    private static java.util.Vector<com.amap.api.mapcore.util.fh> m = new java.util.Vector<>();

    /* renamed from: com.amap.api.mapcore.util.gb$1, reason: invalid class name */
    public static class AnonymousClass1 extends com.amap.api.mapcore.util.ij {
        ...
        public final void runTask() {
            try {
                com.amap.api.mapcore.util.ge.b(this.a);
                com.amap.api.mapcore.util.ge.d(this.a);
                com.amap.api.mapcore.util.ge.c(this.a);
                com.amap.api.mapcore.util.hr.a(this.a);
                com.amap.api.mapcore.util.hp.a(this.a);
            } catch (java.util.concurrent.RejectedExecutionException unused) {
            } catch (java.lang.Throwable th) {
                com.amap.api.mapcore.util.gd.c(th, "Lg", "proL");
            }
        }
    }
    ...
    public static java.util.List<com.amap.api.mapcore.util.fh> a() {
        java.util.Vector<com.amap.api.mapcore.util.fh> vector;
        try {
    ...
    public static void a(android.content.Context context) {
        try {
            ...
            com.amap.api.mapcore.util.ii.a().a(new com.amap.api.mapcore.util.gb.AnonymousClass1(context));
        } catch (java.lang.Throwable th) {
            com.amap.api.mapcore.util.gd.c(th, "Lg", "proL");
        }
    }
    ...
    public static void a(com.amap.api.mapcore.util.fh fhVar) {
        try {
            synchronized (android.os.Looper.getMainLooper()) {
                if (fhVar == null) {
                    return;
