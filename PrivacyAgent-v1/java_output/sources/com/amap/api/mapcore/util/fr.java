...
public final class fr {
    ...
    public static java.lang.String a() {
        ...
        try {
            javax.crypto.KeyGenerator keyGenerator = javax.crypto.KeyGenerator.getInstance(com.amap.api.mapcore.util.fi.c("EQUVT"));
            keyGenerator.init(128, secureRandom);
            return com.amap.api.mapcore.util.fm.a(keyGenerator.generateKey().getEncoded());
    ...
    public static java.lang.String a(java.lang.String str) {
        return com.amap.api.mapcore.util.fd.b(str);
    }
    ...
    private static byte[] a(byte[] bArr) {
        try {
            if (a == null) {
                a = com.amap.api.mapcore.util.fi.c("YAAAAAAAAAAAAAAAAAAAAAA").getBytes();
            }
            javax.crypto.spec.IvParameterSpec ivParameterSpec = new javax.crypto.spec.IvParameterSpec(a);
            javax.crypto.spec.SecretKeySpec secretKeySpec = new javax.crypto.spec.SecretKeySpec(a(b()).getBytes("UTF-8"), com.amap.api.mapcore.util.fi.c("EQUVT"));
    ...
    public static java.lang.String b(java.lang.String str) {
        try {
            return com.amap.api.mapcore.util.fm.a(a(str.getBytes("UTF-8")));
        } catch (java.lang.Throwable unused) {
            return null;
        }
    }
    ...
    private static int[] b() {
        ...
        while (true) {
            ...
            byte[] b2 = com.amap.api.mapcore.util.fa.b(strArr[i]);
