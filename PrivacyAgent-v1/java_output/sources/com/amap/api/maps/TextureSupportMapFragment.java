...
public class TextureSupportMapFragment extends androidx.fragment.app.Fragment implements com.amap.api.maps.BaseMapView {
    ...
    public static com.amap.api.maps.TextureSupportMapFragment newInstance(com.amap.api.maps.AMapOptions aMapOptions) {
        com.amap.api.maps.TextureSupportMapFragment textureSupportMapFragment = new com.amap.api.maps.TextureSupportMapFragment();
    ...
    public com.autonavi.amap.mapcore.interfaces.IMapFragmentDelegate getMapFragmentDelegate(android.content.Context context) {
        ...
        if (iMapFragmentDelegate == null && iMapFragmentDelegate == null) {
            com.amap.api.mapcore.util.p pVar = new com.amap.api.mapcore.util.p(1);
