...
public abstract class GLOverlay {
    ...
    protected com.autonavi.base.amap.api.mapcore.IAMapDelegate mGLMapView;
    ...
    public GLOverlay(int i, com.autonavi.base.amap.api.mapcore.IAMapDelegate iAMapDelegate, int i2) {
        this.mEngineID = i;
