...
public final class c {
    public static java.util.Map<java.lang.String, java.lang.String> a(android.content.Context context) {
        com.alipay.sdk.m.a0.b b = com.alipay.sdk.m.a0.b.b();
        java.util.HashMap hashMap = new java.util.HashMap();
        com.alipay.apmobilesecuritysdk.e.f a = com.alipay.apmobilesecuritysdk.e.e.a(context);
        java.lang.String a2 = b.a(context);
        java.lang.String b2 = b.b(context);
        java.lang.String m = com.alipay.sdk.m.a0.b.m(context);
        if (a != null) {
        ...
        com.alipay.apmobilesecuritysdk.e.f fVar = new com.alipay.apmobilesecuritysdk.e.f(a2, b2, "", "", m);
        if (context != null) {
            try {
