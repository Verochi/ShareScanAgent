...
public class a extends com.heytap.msp.push.encrypt.b {
    ...
    private static final int f376s = 63;
    ...
    */
    ...
    public static byte[] a(byte[] bArr, boolean z, boolean z2, int i) {
        ...
        com.heytap.msp.push.encrypt.a aVar = z ? new com.heytap.msp.push.encrypt.a(z2) : new com.heytap.msp.push.encrypt.a(0, a, z2);
        long m2 = aVar.m(bArr);
        if (m2 <= i) {
    ...
    public static boolean b(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            if (!a(bArr[i]) && !com.heytap.msp.push.encrypt.b.c(bArr[i])) {
                return false;
            }
        }
        return true;
    ...
    public static byte[] b(java.lang.String str) {
        return new com.heytap.msp.push.encrypt.a().c(str);
    }
    ...
    public static byte[] h(byte[] bArr) {
        return new com.heytap.msp.push.encrypt.a().decode(bArr);
    }
