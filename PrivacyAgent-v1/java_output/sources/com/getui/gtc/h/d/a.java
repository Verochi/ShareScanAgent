...
public final class a {
    ...
    public static android.content.pm.PackageInfo a(java.lang.String str) throws android.content.pm.PackageManager.NameNotFoundException {
        android.content.pm.PackageInfo a2 = a(str, a());
        if (a2 != null) {
            return a2;
        }
    ...
    private static android.content.pm.PackageInfo a(java.lang.String str, int i) {
        try {
            if (b == null) {
            ...
            return (android.content.pm.PackageInfo) c.invoke(b, str, 0, java.lang.Integer.valueOf(i));
        } catch (java.lang.Throwable th) {
            com.getui.gtc.h.c.a.b(th);
            return null;
        }
    ...
    private static android.content.pm.PackageInfo b(java.lang.String str) {
        try {
