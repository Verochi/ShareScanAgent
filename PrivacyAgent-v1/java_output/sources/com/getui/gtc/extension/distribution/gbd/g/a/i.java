...
public final class i extends com.getui.gtc.extension.distribution.gbd.g.d {
    private static final java.lang.String A = "GBD_UBIP";
    ...
    public i(byte[] bArr, java.util.List<com.getui.gtc.extension.distribution.gbd.c.p> list) {
    ...
    public i(byte[] bArr, java.util.List<com.getui.gtc.extension.distribution.gbd.c.p> list, android.util.Pair<android.net.Network, android.net.ConnectivityManager.NetworkCallback> pair, android.net.ConnectivityManager connectivityManager) {
        super(com.getui.gtc.extension.distribution.gbd.g.b.a());
        this.l = true;
        this.z = list;
        this.y = 255;
    ...
    private void a(byte[] bArr) {
        ...
        com.getui.gtc.extension.distribution.gbd.n.j.b(A, "gbdreportReq|".concat("255"));
    }
