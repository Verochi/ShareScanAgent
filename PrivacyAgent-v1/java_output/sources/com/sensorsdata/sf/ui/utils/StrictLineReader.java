...
class StrictLineReader implements java.io.Closeable {
    ...
    /* renamed from: com.sensorsdata.sf.ui.utils.StrictLineReader$1, reason: invalid class name */
    public class AnonymousClass1 extends java.io.ByteArrayOutputStream {
        ...
        public java.lang.String toString() {
            ...
            return new java.lang.String(((java.io.ByteArrayOutputStream) this).buf, 0, i, com.sensorsdata.sf.ui.utils.StrictLineReader.this.charset);
        }
    }

    public StrictLineReader(java.io.InputStream inputStream) {
        this(inputStream, 8192);
    }

    public StrictLineReader(java.io.InputStream inputStream, int i) {
        this(inputStream, i, com.sensorsdata.sf.ui.utils.IoUtils.US_ASCII);
    }
    ...
    public StrictLineReader(java.io.InputStream inputStream, int i, java.nio.charset.Charset charset) {
        ...
        if (!charset.equals(com.sensorsdata.sf.ui.utils.IoUtils.US_ASCII) && !charset.equals(com.sensorsdata.sf.ui.utils.IoUtils.UTF_8)) {
    ...
    public int readInt() throws java.io.IOException {
        ...
        try {
            ...
            throw new java.io.IOException("expected an int but was \"" + readLine + "\"");
        }
    }
            ...
            for (int i3 = this.pos; i3 != this.end; i3++) {
                ...
                if (bArr2[i3] == 10) {
                    ...
                    if (i3 != i4) {
                        i2 = i3 - 1;
                        if (bArr2[i2] == 13) {
                            java.lang.String str = new java.lang.String(bArr2, i4, i2 - i4, this.charset);
                            this.pos = i3 + 1;
                            return str;
                        }
                    }
                    i2 = i3;
                    java.lang.String str2 = new java.lang.String(bArr2, i4, i2 - i4, this.charset);
                    this.pos = i3 + 1;
                    return str2;
                }
            }
            com.sensorsdata.sf.ui.utils.StrictLineReader.AnonymousClass1 anonymousClass1 = new com.sensorsdata.sf.ui.utils.StrictLineReader.AnonymousClass1((this.end - this.pos) + 80);
            loop1: while (true) {
                byte[] bArr3 = this.buf;
                int i5 = this.pos;
