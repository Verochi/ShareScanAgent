...
public abstract class RoundedBitmapDrawable extends android.graphics.drawable.Drawable {
    ...
    public RoundedBitmapDrawable(android.content.res.Resources resources, android.graphics.Bitmap bitmap, boolean z) {
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        canvas.drawRect(new android.graphics.Rect(0, (int) (height - f2), (int) f2, this.mDstRect.height()), this.mPaint);
        canvas.drawRect(new android.graphics.Rect((int) (this.mDstRect.width() - this.mCornerRadius), (int) (this.mDstRect.height() - this.mCornerRadius), this.mDstRect.width(), this.mDstRect.height()), this.mPaint);
    }
