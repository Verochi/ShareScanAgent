...
public class SAAdvertAppViewScreenPlugin extends com.sensorsdata.analytics.android.sdk.plugin.property.SAPropertyPlugin {
    ...
    public void properties(com.sensorsdata.analytics.android.sdk.plugin.property.beans.SAPropertiesFetcher sAPropertiesFetcher) {
        ...
        com.sensorsdata.analytics.android.sdk.advert.deeplink.DeepLinkManager.mergeDeepLinkProperty(jSONObject);
        if (jSONObject.length() > 0) {
            ...
            com.sensorsdata.analytics.android.sdk.advert.deeplink.DeepLinkManager.resetDeepLinkProcessor();
        }
    }
}
