...
public final class ExternalPreferredCacheDiskCacheFactory extends com.bumptech.glide.load.engine.cache.DiskLruCacheFactory {
    ...
    public class AnonymousClass1 implements com.bumptech.glide.load.engine.cache.DiskLruCacheFactory.CacheDirectoryGetter {
        ...
        public java.io.File getCacheDirectory() {
            ...
            return ((internalCacheDirectory == null || !internalCacheDirectory.exists()) && (externalCacheDir = this.val$context.getExternalCacheDir()) != null && externalCacheDir.canWrite()) ? this.val$diskCacheName != null ? new java.io.File(externalCacheDir, this.val$diskCacheName) : externalCacheDir : internalCacheDirectory;
        }
    }
    ...
    public ExternalPreferredCacheDiskCacheFactory(android.content.Context context, java.lang.String str, long j) {
        super(new com.bumptech.glide.load.engine.cache.ExternalPreferredCacheDiskCacheFactory.AnonymousClass1(context, str), j);
    }
}
