...
public final class DiskLruCache implements java.io.Closeable {
    ...
    final java.util.concurrent.ThreadPoolExecutor executorService = new java.util.concurrent.ThreadPoolExecutor(0, 1, 60, java.util.concurrent.TimeUnit.SECONDS, new java.util.concurrent.LinkedBlockingQueue(), new com.bumptech.glide.disklrucache.DiskLruCache.DiskLruCacheThreadFactory(null));
    private final java.util.concurrent.Callable<java.lang.Void> cleanupCallable = new com.bumptech.glide.disklrucache.DiskLruCache.AnonymousClass1();

    /* renamed from: com.bumptech.glide.disklrucache.DiskLruCache$1, reason: invalid class name */
    ...
    public static final class DiskLruCacheThreadFactory implements java.util.concurrent.ThreadFactory {
        ...
        public /* synthetic */ DiskLruCacheThreadFactory(com.bumptech.glide.disklrucache.DiskLruCache.AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    public final class Editor {
        ...
        public /* synthetic */ Editor(com.bumptech.glide.disklrucache.DiskLruCache diskLruCache, com.bumptech.glide.disklrucache.DiskLruCache.Entry entry, com.bumptech.glide.disklrucache.DiskLruCache.AnonymousClass1 anonymousClass1) {
            this(entry);
        }
        ...
        public java.io.File getFile(int i) throws java.io.IOException {
            ...
            synchronized (com.bumptech.glide.disklrucache.DiskLruCache.this) {
                ...
                if (!com.bumptech.glide.disklrucache.DiskLruCache.this.directory.exists()) {
    ...
    public final class Entry {
        ...
        public /* synthetic */ Entry(com.bumptech.glide.disklrucache.DiskLruCache diskLruCache, java.lang.String str, com.bumptech.glide.disklrucache.DiskLruCache.AnonymousClass1 anonymousClass1) {
            this(str);
        }
    ...
    public final class Value {
        ...
        public /* synthetic */ Value(com.bumptech.glide.disklrucache.DiskLruCache diskLruCache, java.lang.String str, long j, java.io.File[] fileArr, long[] jArr, com.bumptech.glide.disklrucache.DiskLruCache.AnonymousClass1 anonymousClass1) {
    ...
    public synchronized com.bumptech.glide.disklrucache.DiskLruCache.Editor edit(java.lang.String str, long j) throws java.io.IOException {
        ...
        if (entry == null) {
            entry = new com.bumptech.glide.disklrucache.DiskLruCache.Entry(this, str, null);
            this.lruEntries.put(str, entry);
        } else if (entry.currentEditor != null) {
            return null;
        }
        com.bumptech.glide.disklrucache.DiskLruCache.Editor editor = new com.bumptech.glide.disklrucache.DiskLruCache.Editor(this, entry, null);
    ...
    private void readJournalLine(java.lang.String str) throws java.io.IOException {
        ...
        if (entry == null) {
            entry = new com.bumptech.glide.disklrucache.DiskLruCache.Entry(this, substring, null);
        ...
        if (indexOf2 == -1 && indexOf == 5 && str.startsWith(DIRTY)) {
            entry.currentEditor = new com.bumptech.glide.disklrucache.DiskLruCache.Editor(this, entry, null);
            return;
        }
    ...
    public synchronized com.bumptech.glide.disklrucache.DiskLruCache.Value get(java.lang.String str) throws java.io.IOException {
        ...
        return new com.bumptech.glide.disklrucache.DiskLruCache.Value(this, str, entry.sequenceNumber, entry.cleanFiles, entry.lengths, null);
    }
