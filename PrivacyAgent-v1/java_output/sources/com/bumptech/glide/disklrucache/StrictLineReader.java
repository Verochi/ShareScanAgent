...
class StrictLineReader implements java.io.Closeable {
    ...
    public class AnonymousClass1 extends java.io.ByteArrayOutputStream {
        ...
        public java.lang.String toString() {
            ...
            try {
                return new java.lang.String(((java.io.ByteArrayOutputStream) this).buf, 0, i, com.bumptech.glide.disklrucache.StrictLineReader.this.charset.name());
    ...
    public java.lang.String readLine() throws java.io.IOException {
        ...
        synchronized (this.in) {
            ...
            com.bumptech.glide.disklrucache.StrictLineReader.AnonymousClass1 anonymousClass1 = new com.bumptech.glide.disklrucache.StrictLineReader.AnonymousClass1((this.end - this.pos) + 80);
            loop1: while (true) {
                byte[] bArr3 = this.buf;
                int i5 = this.pos;
