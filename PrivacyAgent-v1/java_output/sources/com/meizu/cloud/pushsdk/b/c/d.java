...
public final class d {
    ...
    /* renamed from: com.meizu.cloud.pushsdk.b.c.d$1, reason: invalid class name */
    ...
    private static java.util.concurrent.ThreadFactory a(com.meizu.cloud.pushsdk.b.c.d dVar) {
        java.lang.String str = dVar.a;
        java.lang.Boolean bool = dVar.b;
        java.lang.Integer num = dVar.c;
        java.lang.Thread.UncaughtExceptionHandler uncaughtExceptionHandler = dVar.d;
        java.util.concurrent.ThreadFactory threadFactory = dVar.e;
        if (threadFactory == null) {
            threadFactory = java.util.concurrent.Executors.defaultThreadFactory();
        }
        return new com.meizu.cloud.pushsdk.b.c.d.AnonymousClass1(threadFactory, str, str != null ? new java.util.concurrent.atomic.AtomicLong(0L) : null, bool, num, uncaughtExceptionHandler);
    }

    public com.meizu.cloud.pushsdk.b.c.d a(java.lang.Integer num) {
        this.c = num;
        return this;
    }

    public com.meizu.cloud.pushsdk.b.c.d a(java.lang.String str) {
