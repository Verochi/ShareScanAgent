...
public final class m {
    ...
    /* renamed from: com.loc.m$1, reason: invalid class name */
    public class AnonymousClass1 extends com.loc.cu {
        ...
        public final void a() {
            ...
            try {
                java.io.File file = new java.io.File(com.loc.au.c(this.a, "k.store"));
                if (!file.getParentFile().exists()) {
                    file.getParentFile().mkdirs();
                }
                java.io.FileOutputStream fileOutputStream2 = new java.io.FileOutputStream(file);
                try {
                    fileOutputStream2.write(com.loc.y.a(this.b));
                    try {
                    ...
                    try {
                        com.loc.at.a(th, "AI", com.umeng.analytics.pro.bs.c);
    ...
    public static void a(android.content.Context context, java.lang.String str) {
        ...
        f = str;
        if (context != null) {
            com.loc.ct.a().b(new com.loc.m.AnonymousClass1(context, str));
        }
    }
    ...
    private static boolean b(java.lang.String str) {
        ...
        for (char c2 : str.toCharArray()) {
            if (('A' > c2 || c2 > 'z') && (('0' > c2 || c2 > ':') && c2 != '.')) {
                try {
                    com.loc.aw.b(com.loc.y.a(), str, "errorPackage");
    ...
    public static java.lang.String e(android.content.Context context) {
        try {
            ...
            byte[] digest = java.security.MessageDigest.getInstance(com.loc.y.c("IU0hBMQ")).digest(packageInfo.signatures[0].toByteArray());
    ...
    */
    private static java.lang.String g(android.content.Context context) {
        ...
        java.io.File file = new java.io.File(com.loc.au.c(context, "k.store"));
        if (!file.exists()) {
            return "";
        }
        try {
            ...
            try {
                ...
                java.lang.String a2 = com.loc.y.a(bArr);
