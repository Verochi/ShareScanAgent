...
public final class r {
    private volatile com.loc.r.b a = new com.loc.r.b((byte) 0);
    private com.loc.be b = new com.loc.be("HttpsDecisionUtil");

    public static class a {
        static com.loc.r a = new com.loc.r();
    }
    ...
    public final void a(android.content.Context context) {
        if (this.a == null) {
            this.a = new com.loc.r.b((byte) 0);
        }
        this.a.a(com.loc.be.a(context, "open_common", "a3", true));
        this.a.a(context);
        com.loc.ai.a(context).a();
    }
