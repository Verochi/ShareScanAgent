...
public class b2 {
    ...
    public static java.lang.String c() throws java.lang.Exception {
        ...
        aVar.c.clear();
        aVar.c.putAll(b2);
        com.zx.a.I8b7.q1.a a2 = aVar.a("https://zxid-m.mobileservice.cn/sdk/extend/tag");
        a2.b = "POST";
        ...
        if (a3.b == 200) {
            return com.zx.a.I8b7.p.a(android.util.Base64.decode(new org.json.JSONObject(a3.e.b()).getString("data"), 2), a, "UDID_ENC_AUTHTAG");
        }
