...
public class wg implements com.bykv.vk.openvk.api.proto.Bridge {
    ...
    private final com.bytedance.sdk.openadsdk.TTAdNative.FeedAdListener wg;

    public wg(com.bytedance.sdk.openadsdk.TTAdNative.FeedAdListener feedAdListener) {
        this.wg = feedAdListener;
    }
        ...
        if (this.wg != null) {
            switch (i) {
                ...
                case 164102:
                    ...
                    while (it.hasNext()) {
                        arrayList.add(new com.bytedance.sdk.openadsdk.t.vw.vw.z((com.bykv.vk.openvk.api.proto.Bridge) it.next()));
                    }
                    this.wg.onFeedAdLoad(arrayList);
                    break;
            }
        } else {
            return null;
