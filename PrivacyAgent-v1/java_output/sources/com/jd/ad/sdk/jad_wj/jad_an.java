...
public enum jad_an {
    ...
    CACHE_EXEC_SQL_ERROR(com.alimm.tanx.core.constant.AdType.COMMON_AD, "exec sql error"),
    ...
    AN_REQUEST_ERROR(com.igexin.sdk.PushConsts.ALIAS_ERROR_FREQUENCY, "an request error"),
    AN_REQUEST_OTHER_ERROR(com.igexin.sdk.PushConsts.ALIAS_OPERATE_PARAM_ERROR, "an request other error"),
    AN_REQUEST_JSON_ERROR(com.igexin.sdk.PushConsts.ALIAS_REQUEST_FILTER, "an request json error"),
    AN_RESULT_BODY_NULL_ERROR(com.igexin.sdk.PushConsts.ALIAS_OPERATE_ALIAS_FAILED, "an response body is null"),
    AN_RESPONSE_BODY_CONTENT_NULL_ERROR(com.igexin.sdk.PushConsts.ALIAS_CID_LOST, "an response data is null"),
    AN_RESPONSE_DATA_IO_ERROR(com.igexin.sdk.PushConsts.ALIAS_CONNECT_LOST, "an response read data io error"),
    AN_RESPONSE_DATA_DES_ERROR(com.igexin.sdk.PushConsts.ALIAS_INVALID, "an response data decrypt error"),
    AN_RESPONSE_JSON_PARSER_ERROR(com.igexin.sdk.PushConsts.ALIAS_SN_INVALID, "an response json parse error"),
    ...
    EXPOSURE_SERVER_REPORT_ERROR(com.badlogic.gdx.graphics.GL20.GL_TEXTURE18, "gw exposure server report failed"),
