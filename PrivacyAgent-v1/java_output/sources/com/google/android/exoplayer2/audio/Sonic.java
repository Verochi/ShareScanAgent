...
final class Sonic {
    ...
    public final void b(float f) {
        ...
        do {
            if (this.r > 0) {
                ...
                int g = g(this.j, i2);
                v = ((double) f) > 1.0d ? g + v(this.j, i2, f, g) : l(this.j, i2, f, g);
            }
            i2 += v;
        } while (this.h + i2 <= i);
        u(i2);
    ...
    public final int c(int i) {
        int min = java.lang.Math.min(this.h, this.r);
        d(this.j, i, min);
        this.r -= min;
        return min;
    }
    ...
    public final void d(short[] sArr, int i, int i2) {
        ...
        this.l = f;
        int i3 = this.b;
        java.lang.System.arraycopy(sArr, i * i3, f, this.m * i3, i3 * i2);
        this.m += i2;
    }
    ...
    public final int g(short[] sArr, int i) {
        ...
        int i11 = p(this.u, this.v) ? this.f344s : i2;
        this.t = this.u;
        this.f344s = i2;
        return i11;
    }
    ...
    public void j(java.nio.ShortBuffer shortBuffer) {
        int min = java.lang.Math.min(shortBuffer.remaining() / this.b, this.m);
    ...
    public final int l(short[] sArr, int i, float f, int i2) {
        ...
        this.l = f2;
        int i5 = this.b;
        java.lang.System.arraycopy(sArr, i * i5, f2, this.m * i5, i5 * i2);
    ...
    public final void n(int i) {
        ...
        short[] sArr = this.l;
        int i3 = this.b;
        java.lang.System.arraycopy(sArr, i * i3, f, this.o * i3, i3 * i2);
        this.m = i;
        this.o += i2;
    }

    public final boolean p(int i, int i2) {
        return i != 0 && this.f344s != 0 && i2 <= i * 3 && i * 2 > this.t * 3;
    }
    ...
    public void s(java.nio.ShortBuffer shortBuffer) {
