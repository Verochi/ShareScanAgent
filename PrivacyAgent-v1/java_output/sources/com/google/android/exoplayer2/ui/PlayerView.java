...
public class PlayerView extends android.widget.FrameLayout implements com.google.android.exoplayer2.source.ads.AdsLoader.AdViewProvider {
    public static final int SHOW_BUFFERING_ALWAYS = 2;
    public static final int SHOW_BUFFERING_NEVER = 0;
    public static final int SHOW_BUFFERING_WHEN_PLAYING = 1;

    @androidx.annotation.Nullable
    public final com.google.android.exoplayer2.ui.PlayerControlView A;
    ...
    @androidx.annotation.Nullable
    public com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener F;
    public boolean G;
    ...
    public int R;
    public boolean S;
    public final com.google.android.exoplayer2.ui.PlayerView.ComponentListener n;
    ...
    public final class ComponentListener implements com.google.android.exoplayer2.Player.EventListener, com.google.android.exoplayer2.text.TextOutput, com.google.android.exoplayer2.video.VideoListener, android.view.View.OnLayoutChangeListener, com.google.android.exoplayer2.ui.spherical.SingleTapListener, com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener {
        ...
        public void onCues(java.util.List<com.google.android.exoplayer2.text.Cue> list) {
            if (com.google.android.exoplayer2.ui.PlayerView.this.x != null) {
                com.google.android.exoplayer2.ui.PlayerView.this.x.onCues(list);
            }
        }
        ...
        public void onLayoutChange(android.view.View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            com.google.android.exoplayer2.ui.PlayerView.q((android.view.TextureView) view, com.google.android.exoplayer2.ui.PlayerView.this.R);
        }
        ...
        public void onPlayWhenReadyChanged(boolean z, int i) {
            com.google.android.exoplayer2.ui.PlayerView.this.E();
            com.google.android.exoplayer2.ui.PlayerView.this.G();
        }
        ...
        public void onPlaybackStateChanged(int i) {
            com.google.android.exoplayer2.ui.PlayerView.this.E();
            com.google.android.exoplayer2.ui.PlayerView.this.H();
            com.google.android.exoplayer2.ui.PlayerView.this.G();
        }
        ...
        public void onPositionDiscontinuity(int i) {
            if (com.google.android.exoplayer2.ui.PlayerView.this.w() && com.google.android.exoplayer2.ui.PlayerView.this.P) {
        ...
        public void onRenderedFirstFrame() {
            if (com.google.android.exoplayer2.ui.PlayerView.this.u != null) {
                com.google.android.exoplayer2.ui.PlayerView.this.u.setVisibility(4);
            }
        }
        ...
        public boolean onSingleTapUp(android.view.MotionEvent motionEvent) {
            return com.google.android.exoplayer2.ui.PlayerView.this.D();
        }
        ...
        public void onTracksChanged(com.google.android.exoplayer2.source.TrackGroupArray trackGroupArray, com.google.android.exoplayer2.trackselection.TrackSelectionArray trackSelectionArray) {
            com.google.android.exoplayer2.Player player = (com.google.android.exoplayer2.Player) com.google.android.exoplayer2.util.Assertions.checkNotNull(com.google.android.exoplayer2.ui.PlayerView.this.D);
            ...
            com.google.android.exoplayer2.ui.PlayerView.this.I(false);
        }

        @Override // com.google.android.exoplayer2.video.VideoListener
        public void onVideoSizeChanged(int i, int i2, int i3, float f) {
            float f2 = (i2 == 0 || i == 0) ? 1.0f : (i * f) / i2;
            if (com.google.android.exoplayer2.ui.PlayerView.this.v instanceof android.view.TextureView) {
                if (i3 == 90 || i3 == 270) {
                    f2 = 1.0f / f2;
                }
                if (com.google.android.exoplayer2.ui.PlayerView.this.R != 0) {
                    com.google.android.exoplayer2.ui.PlayerView.this.v.removeOnLayoutChangeListener(this);
                }
                com.google.android.exoplayer2.ui.PlayerView.this.R = i3;
                if (com.google.android.exoplayer2.ui.PlayerView.this.R != 0) {
                    com.google.android.exoplayer2.ui.PlayerView.this.v.addOnLayoutChangeListener(this);
                }
                com.google.android.exoplayer2.ui.PlayerView.q((android.view.TextureView) com.google.android.exoplayer2.ui.PlayerView.this.v, com.google.android.exoplayer2.ui.PlayerView.this.R);
            }
            com.google.android.exoplayer2.ui.PlayerView playerView = com.google.android.exoplayer2.ui.PlayerView.this;
            playerView.onContentAspectRatioChanged(f2, playerView.t, com.google.android.exoplayer2.ui.PlayerView.this.v);
        }

        @Override // com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener
        public void onVisibilityChange(int i) {
            com.google.android.exoplayer2.ui.PlayerView.this.F();
        }
    }
    ...
    public PlayerView(android.content.Context context, @androidx.annotation.Nullable android.util.AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            android.content.res.TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, com.google.android.exoplayer2.ui.R.styleable.PlayerView, 0, 0);
            try {
                int i9 = com.google.android.exoplayer2.ui.R.styleable.PlayerView_shutter_background_color;
                ...
                boolean z7 = obtainStyledAttributes.getBoolean(com.google.android.exoplayer2.ui.R.styleable.PlayerView_use_artwork, true);
                ...
                boolean z8 = obtainStyledAttributes.getBoolean(com.google.android.exoplayer2.ui.R.styleable.PlayerView_use_controller, true);
                int i10 = obtainStyledAttributes.getInt(com.google.android.exoplayer2.ui.R.styleable.PlayerView_surface_type, 1);
                int i11 = obtainStyledAttributes.getInt(com.google.android.exoplayer2.ui.R.styleable.PlayerView_resize_mode, 0);
                int i12 = obtainStyledAttributes.getInt(com.google.android.exoplayer2.ui.R.styleable.PlayerView_show_timeout, 5000);
                boolean z9 = obtainStyledAttributes.getBoolean(com.google.android.exoplayer2.ui.R.styleable.PlayerView_hide_on_touch, true);
                boolean z10 = obtainStyledAttributes.getBoolean(com.google.android.exoplayer2.ui.R.styleable.PlayerView_auto_show, true);
                i2 = obtainStyledAttributes.getInteger(com.google.android.exoplayer2.ui.R.styleable.PlayerView_show_buffering, 0);
                this.J = obtainStyledAttributes.getBoolean(com.google.android.exoplayer2.ui.R.styleable.PlayerView_keep_content_on_player_reset, this.J);
                ...
                this.K = obtainStyledAttributes.getBoolean(com.google.android.exoplayer2.ui.R.styleable.PlayerView_use_sensor_rotation, this.K);
        ...
        com.google.android.exoplayer2.ui.PlayerControlView playerControlView = (com.google.android.exoplayer2.ui.PlayerControlView) findViewById(i13);
        ...
        com.google.android.exoplayer2.ui.PlayerControlView playerControlView3 = this.A;
        this.N = playerControlView3 != null ? i7 : 0;
        this.Q = z3;
        this.O = z;
        this.P = z2;
        this.E = z6 && playerControlView3 != null;
        hideController();
        F();
        com.google.android.exoplayer2.ui.PlayerControlView playerControlView4 = this.A;
    ...
    public static void switchTargetView(com.google.android.exoplayer2.Player player, @androidx.annotation.Nullable com.google.android.exoplayer2.ui.PlayerView playerView, @androidx.annotation.Nullable com.google.android.exoplayer2.ui.PlayerView playerView2) {
    ...
    public final boolean B() {
        ...
        return this.O && (playbackState == 1 || playbackState == 4 || !this.D.getPlayWhenReady());
    }
    ...
    */
    ...
    public final void F() {
        com.google.android.exoplayer2.ui.PlayerControlView playerControlView = this.A;
    ...
    public java.util.List<com.google.android.exoplayer2.source.ads.AdsLoader.OverlayInfo> getAdOverlayInfos() {
        ...
        com.google.android.exoplayer2.ui.PlayerControlView playerControlView = this.A;
        if (playerControlView != null) {
            arrayList.add(new com.google.android.exoplayer2.source.ads.AdsLoader.OverlayInfo(playerControlView, 0));
        }
    ...
    public void setControllerVisibilityListener(@androidx.annotation.Nullable com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener visibilityListener) {
        com.google.android.exoplayer2.util.Assertions.checkStateNotNull(this.A);
        com.google.android.exoplayer2.ui.PlayerControlView.VisibilityListener visibilityListener2 = this.F;
    ...
    public void setDefaultArtwork(@androidx.annotation.Nullable android.graphics.Bitmap bitmap) {
        setDefaultArtwork(bitmap == null ? null : new android.graphics.drawable.BitmapDrawable(getResources(), bitmap));
    }
