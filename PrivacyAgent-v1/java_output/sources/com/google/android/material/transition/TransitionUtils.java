...
class TransitionUtils {
    ...
    public static class AnonymousClass2 implements com.google.android.material.transition.TransitionUtils.CornerSizeBinaryOperator {
        ...
        public com.google.android.material.shape.CornerSize apply(@androidx.annotation.NonNull com.google.android.material.shape.CornerSize cornerSize, @androidx.annotation.NonNull com.google.android.material.shape.CornerSize cornerSize2) {
            return new com.google.android.material.shape.AbsoluteCornerSize(com.google.android.material.transition.TransitionUtils.lerp(cornerSize.getCornerSize(this.val$startBounds), cornerSize2.getCornerSize(this.val$endBounds), this.val$startFraction, this.val$endFraction, this.val$fraction));
        }
    }
    ...
    public static com.google.android.material.shape.ShapeAppearanceModel convertToRelativeCornerSizes(com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel, android.graphics.RectF rectF) {
        return shapeAppearanceModel.withTransformedCornerSizes(new com.google.android.material.transition.TransitionUtils.AnonymousClass1(rectF));
    }
    ...
    public static com.google.android.material.shape.ShapeAppearanceModel lerp(com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel, com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel2, android.graphics.RectF rectF, android.graphics.RectF rectF2, @androidx.annotation.FloatRange(from = 0.0d, to = 1.0d) float f, @androidx.annotation.FloatRange(from = 0.0d, to = 1.0d) float f2, @androidx.annotation.FloatRange(from = 0.0d, to = 1.0d) float f3) {
        return f3 < f ? shapeAppearanceModel : f3 > f2 ? shapeAppearanceModel2 : transformCornerSizes(shapeAppearanceModel, shapeAppearanceModel2, rectF, new com.google.android.material.transition.TransitionUtils.AnonymousClass2(rectF, rectF2, f, f2, f3));
    }

    public static void maybeAddTransition(androidx.transition.TransitionSet transitionSet, @androidx.annotation.Nullable androidx.transition.Transition transition) {
        if (transition != null) {
            transitionSet.addTransition(transition);
        }
    }

    public static boolean maybeApplyThemeDuration(androidx.transition.Transition transition, android.content.Context context, @androidx.annotation.AttrRes int i) {
        int resolveInteger;
    ...
    public static boolean maybeApplyThemeInterpolator(androidx.transition.Transition transition, android.content.Context context, @androidx.annotation.AttrRes int i, android.animation.TimeInterpolator timeInterpolator) {
    ...
    public static boolean maybeApplyThemePath(androidx.transition.Transition transition, android.content.Context context, @androidx.annotation.AttrRes int i) {
    ...
    public static void maybeRemoveTransition(androidx.transition.TransitionSet transitionSet, @androidx.annotation.Nullable androidx.transition.Transition transition) {
        if (transition != null) {
    ...
    public static androidx.transition.PathMotion resolveThemePath(android.content.Context context, @androidx.annotation.AttrRes int i) {
        android.util.TypedValue typedValue = new android.util.TypedValue();
        if (!context.getTheme().resolveAttribute(i, typedValue, true)) {
            return null;
        }
    ...
    public static void transform(android.graphics.Canvas canvas, android.graphics.Rect rect, float f, float f2, float f3, int i, com.google.android.material.transition.TransitionUtils.CanvasOperation canvasOperation) {
        if (i <= 0) {
            return;
        }
