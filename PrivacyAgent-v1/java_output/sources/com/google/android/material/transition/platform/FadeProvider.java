...
public final class FadeProvider implements com.google.android.material.transition.platform.VisibilityAnimatorProvider {
    ...
    private static android.animation.Animator createFadeAnimator(android.view.View view, float f, float f2, @androidx.annotation.FloatRange(from = 0.0d, to = 1.0d) float f3, @androidx.annotation.FloatRange(from = 0.0d, to = 1.0d) float f4, float f5) {
        ...
        ofFloat.addUpdateListener(new com.google.android.material.transition.platform.FadeProvider.AnonymousClass1(view, f, f2, f3, f4));
        ofFloat.addListener(new com.google.android.material.transition.platform.FadeProvider.AnonymousClass2(view, f5));
        return ofFloat;
    }
