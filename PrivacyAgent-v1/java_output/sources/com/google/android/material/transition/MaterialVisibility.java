...
abstract class MaterialVisibility<P extends com.google.android.material.transition.VisibilityAnimatorProvider> extends androidx.transition.Visibility {
    ...
    public MaterialVisibility(P p, @androidx.annotation.Nullable com.google.android.material.transition.VisibilityAnimatorProvider visibilityAnimatorProvider) {
        this.primaryAnimatorProvider = p;
        this.secondaryAnimatorProvider = visibilityAnimatorProvider;
    }

    private static void addAnimatorIfNeeded(java.util.List<android.animation.Animator> list, @androidx.annotation.Nullable com.google.android.material.transition.VisibilityAnimatorProvider visibilityAnimatorProvider, android.view.ViewGroup viewGroup, android.view.View view, boolean z) {
    ...
    public void addAdditionalAnimatorProvider(@androidx.annotation.NonNull com.google.android.material.transition.VisibilityAnimatorProvider visibilityAnimatorProvider) {
    ...
    public boolean removeAdditionalAnimatorProvider(@androidx.annotation.NonNull com.google.android.material.transition.VisibilityAnimatorProvider visibilityAnimatorProvider) {
        return this.additionalAnimatorProviders.remove(visibilityAnimatorProvider);
    }

    public void setSecondaryAnimatorProvider(@androidx.annotation.Nullable com.google.android.material.transition.VisibilityAnimatorProvider visibilityAnimatorProvider) {
        this.secondaryAnimatorProvider = visibilityAnimatorProvider;
    }
}
