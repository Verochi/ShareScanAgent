...
public final class SlideDistanceProvider implements com.google.android.material.transition.VisibilityAnimatorProvider {
    ...
    private static android.animation.Animator createTranslationXAnimator(android.view.View view, float f, float f2, float f3) {
        ...
        ofPropertyValuesHolder.addListener(new com.google.android.material.transition.SlideDistanceProvider.AnonymousClass1(view, f3));
    ...
    private static android.animation.Animator createTranslationYAnimator(android.view.View view, float f, float f2, float f3) {
        ...
        ofPropertyValuesHolder.addListener(new com.google.android.material.transition.SlideDistanceProvider.AnonymousClass2(view, f3));
        return ofPropertyValuesHolder;
    }
