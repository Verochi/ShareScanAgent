...
public final class MaterialContainerTransform extends android.transition.Transition {
    ...
    public class AnonymousClass1 implements android.animation.ValueAnimator.AnimatorUpdateListener {
        final /* synthetic */ com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable val$transitionDrawable;

        public AnonymousClass1(com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable transitionDrawable) {
    ...
    public class AnonymousClass2 extends com.google.android.material.transition.platform.TransitionListenerAdapter {
        ...
        public AnonymousClass2(android.view.View view, com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable transitionDrawable, android.view.View view2, android.view.View view3) {
        ...
        public void onTransitionEnd(@androidx.annotation.NonNull android.transition.Transition transition) {
        ...
        @Override // com.google.android.material.transition.platform.TransitionListenerAdapter, android.transition.Transition.TransitionListener
        public void onTransitionStart(@androidx.annotation.NonNull android.transition.Transition transition) {
    ...
    public static class ProgressThresholdsGroup {
        ...
        private ProgressThresholdsGroup(@androidx.annotation.NonNull com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds, @androidx.annotation.NonNull com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds2, @androidx.annotation.NonNull com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds3, @androidx.annotation.NonNull com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds4) {
    ...
    public static final class TransitionDrawable extends android.graphics.drawable.Drawable {
        ...
        public class AnonymousClass1 implements com.google.android.material.transition.platform.TransitionUtils.CanvasOperation {
            public AnonymousClass1() {
            }

            @Override // com.google.android.material.transition.platform.TransitionUtils.CanvasOperation
            public void run(android.graphics.Canvas canvas) {
                com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable.this.startView.draw(canvas);
            }
        }
        ...
        public class AnonymousClass2 implements com.google.android.material.transition.platform.TransitionUtils.CanvasOperation {
            public AnonymousClass2() {
            }

            @Override // com.google.android.material.transition.platform.TransitionUtils.CanvasOperation
            public void run(android.graphics.Canvas canvas) {
                com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable.this.endView.draw(canvas);
            }
        }

        private TransitionDrawable(android.transition.PathMotion pathMotion, android.view.View view, android.graphics.RectF rectF, com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel, float f, android.view.View view2, android.graphics.RectF rectF2, com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel2, float f2, @androidx.annotation.ColorInt int i, @androidx.annotation.ColorInt int i2, @androidx.annotation.ColorInt int i3, int i4, boolean z, boolean z2, com.google.android.material.transition.platform.FadeModeEvaluator fadeModeEvaluator, com.google.android.material.transition.platform.FitModeEvaluator fitModeEvaluator, com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholdsGroup progressThresholdsGroup, boolean z3) {
        ...
        private void drawEndView(android.graphics.Canvas canvas) {
            ...
            com.google.android.material.transition.platform.TransitionUtils.transform(canvas, bounds, rectF.left, rectF.top, this.fitModeResult.endScale, this.fadeModeResult.endAlpha, new com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable.AnonymousClass2());
        }
        ...
        private void drawStartView(android.graphics.Canvas canvas) {
            ...
            com.google.android.material.transition.platform.TransitionUtils.transform(canvas, bounds, rectF.left, rectF.top, this.fitModeResult.startScale, this.fadeModeResult.startAlpha, new com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable.AnonymousClass1());
        }
        ...
        private void updateProgress(float f) {
            ...
            com.google.android.material.transition.platform.FitModeResult fitModeResult = this.fitModeResult;
    ...
    private com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholdsGroup buildThresholdsGroup(boolean z) {
        ...
        return ((pathMotion instanceof android.transition.ArcMotion) || (pathMotion instanceof com.google.android.material.transition.platform.MaterialArcMotion)) ? getThresholdsOrDefault(z, DEFAULT_ENTER_THRESHOLDS_ARC, DEFAULT_RETURN_THRESHOLDS_ARC) : getThresholdsOrDefault(z, DEFAULT_ENTER_THRESHOLDS, DEFAULT_RETURN_THRESHOLDS);
    }
    ...
    private static void captureValues(@androidx.annotation.NonNull android.transition.TransitionValues transitionValues, @androidx.annotation.Nullable android.view.View view, @androidx.annotation.IdRes int i, @androidx.annotation.Nullable com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel) {
        ...
        android.graphics.RectF relativeBounds = view4.getParent() == null ? com.google.android.material.transition.platform.TransitionUtils.getRelativeBounds(view4) : com.google.android.material.transition.platform.TransitionUtils.getLocationOnScreen(view4);
    ...
    private void maybeApplyThemeValues(android.content.Context context, boolean z) {
        com.google.android.material.transition.platform.TransitionUtils.maybeApplyThemeInterpolator(this, context, com.google.android.material.R.attr.motionEasingStandard, com.google.android.material.animation.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        com.google.android.material.transition.platform.TransitionUtils.maybeApplyThemeDuration(this, context, z ? com.google.android.material.R.attr.motionDurationLong1 : com.google.android.material.R.attr.motionDurationMedium2);
    ...
    public void captureEndValues(@androidx.annotation.NonNull android.transition.TransitionValues transitionValues) {
        captureValues(transitionValues, this.endView, this.endViewId, this.endShapeAppearanceModel);
    }

    @Override // android.transition.Transition
    public void captureStartValues(@androidx.annotation.NonNull android.transition.TransitionValues transitionValues) {
        captureValues(transitionValues, this.startView, this.startViewId, this.startShapeAppearanceModel);
    }

    @Override // android.transition.Transition
    @androidx.annotation.Nullable
    public android.animation.Animator createAnimator(@androidx.annotation.NonNull android.view.ViewGroup viewGroup, @androidx.annotation.Nullable android.transition.TransitionValues transitionValues, @androidx.annotation.Nullable android.transition.TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                if (rectF2 != null && shapeAppearanceModel2 != null) {
                    ...
                    ofFloat.addUpdateListener(new com.google.android.material.transition.platform.MaterialContainerTransform.AnonymousClass1(transitionDrawable));
                    addListener(new com.google.android.material.transition.platform.MaterialContainerTransform.AnonymousClass2(findAncestorById, transitionDrawable, view2, view3));
                    return ofFloat;
                }
            }
        }
    ...
    public void setFadeProgressThresholds(@androidx.annotation.Nullable com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds) {
    ...
    @Override // android.transition.Transition
    public void setPathMotion(@androidx.annotation.Nullable android.transition.PathMotion pathMotion) {
        super.setPathMotion(pathMotion);
        this.pathMotionCustom = true;
    }

    public void setScaleMaskProgressThresholds(@androidx.annotation.Nullable com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds) {
        this.scaleMaskProgressThresholds = progressThresholds;
    }

    public void setScaleProgressThresholds(@androidx.annotation.Nullable com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds) {
    ...
    public void setShapeMaskProgressThresholds(@androidx.annotation.Nullable com.google.android.material.transition.platform.MaterialContainerTransform.ProgressThresholds progressThresholds) {
