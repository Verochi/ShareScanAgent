...
public class MurmurHash3 {
    ...
    @com.google.android.gms.common.annotation.KeepForSdk
    public static int murmurhash3_x86_32(@androidx.annotation.RecentlyNonNull byte[] bArr, @androidx.annotation.RecentlyNonNull int i, @androidx.annotation.RecentlyNonNull int i2, @androidx.annotation.RecentlyNonNull int i3) {
        int i4 = (i2 & (-4)) + i;
        while (i < i4) {
