...
final class MaskUtil {
    ...
    public static int applyMaskPenaltyRule1(com.google.zxing.qrcode.encoder.ByteMatrix byteMatrix) {
    ...
    public static int applyMaskPenaltyRule2(com.google.zxing.qrcode.encoder.ByteMatrix byteMatrix) {
        byte[][] array = byteMatrix.getArray();
    ...
    public static int applyMaskPenaltyRule3(com.google.zxing.qrcode.encoder.ByteMatrix byteMatrix) {
        byte[][] array = byteMatrix.getArray();
        int width = byteMatrix.getWidth();
        int height = byteMatrix.getHeight();
        int i = 0;
    ...
    public static int applyMaskPenaltyRule4(com.google.zxing.qrcode.encoder.ByteMatrix byteMatrix) {
        byte[][] array = byteMatrix.getArray();
        int width = byteMatrix.getWidth();
        int height = byteMatrix.getHeight();
        int i = 0;
    ...
    public static boolean getDataMaskBit(int i, int i2, int i3) {
        ...
        switch (i) {
            ...
            case 7:
                ...
                break;
            default:
                throw new java.lang.IllegalArgumentException("Invalid mask pattern: " + i);
        }
    }
