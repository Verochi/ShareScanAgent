...
public class SSFSecureX509SingleInstance {
    public static final java.lang.String a = "SSFSecureX509SingleInstance";
    ...
    public static com.huawei.secure.android.common.ssl.SecureX509TrustManager getInstance(android.content.Context context) throws java.security.cert.CertificateException, java.security.NoSuchAlgorithmException, java.security.KeyStoreException, java.io.IOException {
        ...
        if (b == null) {
            synchronized (com.huawei.secure.android.common.ssl.SSFSecureX509SingleInstance.class) {
                if (b == null) {
                    ...
                    b = new com.huawei.secure.android.common.ssl.SecureX509TrustManager(filesBksIS, "", true);
                    new com.huawei.secure.android.common.ssl.util.e().executeOnExecutor(android.os.AsyncTask.THREAD_POOL_EXECUTOR, context);
                }
            }
        }
        return b;
    ...
    public static void updateBks(java.io.InputStream inputStream) {
        ...
        if (inputStream != null && b != null) {
            b = new com.huawei.secure.android.common.ssl.SecureX509TrustManager(inputStream, "", true);
            com.huawei.secure.android.common.ssl.util.g.a(str, "updateBks: new SecureX509TrustManager cost : " + (java.lang.System.currentTimeMillis() - currentTimeMillis) + " ms");
            com.huawei.secure.android.common.ssl.SSFCompatiableSystemCA.b(b);
            com.huawei.secure.android.common.ssl.SASFCompatiableSystemCA.b(b);
        }
        com.huawei.secure.android.common.ssl.util.g.a(str, "update bks cost : " + (java.lang.System.currentTimeMillis() - currentTimeMillis) + " ms");
    }
}
