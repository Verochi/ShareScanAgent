...
public abstract class f {
    ...
    public static void a(java.io.Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                com.huawei.secure.android.common.ssl.util.g.b("IOUtil", "closeSecure IOException");
            }
        }
    }
    ...
    public static void a(java.io.File file) {
        ...
        com.huawei.secure.android.common.ssl.util.g.b("IOUtil", "deleteSecure exception");
    }
