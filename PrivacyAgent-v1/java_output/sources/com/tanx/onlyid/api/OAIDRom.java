...
public final class OAIDRom {
    ...
    public static boolean isFreeme() {
        return !android.text.TextUtils.isEmpty(sysProperty("ro.build.freeme.label", ""));
    }

    public static boolean isHonor() {
        return android.os.Build.BRAND.equalsIgnoreCase("HONOR");
    }
    ...
    public static java.lang.String sysProperty(java.lang.String str, java.lang.String str2) {
        ...
        try {
            ...
            com.tanx.onlyid.api.OAIDLog.print("System property invoke error: " + e);
            str3 = null;
        }
