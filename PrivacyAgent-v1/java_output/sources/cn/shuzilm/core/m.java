...
class m implements java.lang.Runnable {
    ...
    public m(android.content.Context context, java.lang.String str, java.lang.String str2) {
        this.a = context;
        this.b = str;
        this.c = str2;
    }
    ...
    public void run() {
        ...
        try {
            ...
            cn.shuzilm.core.DUHelper.run(context2, jSONObject5, jSONObject4.toString());
