...
public final class FlowKt__LimitKt$drop$$inlined$unsafeFlow$1<T> implements kotlinx.coroutines.flow.Flow<T> {
    ...
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        java.lang.Object collect = this.n.collect(new kotlinx.coroutines.flow.FlowKt__LimitKt$drop$lambda2$$inlined$collect$1(new kotlin.jvm.internal.Ref.IntRef(), this.t, flowCollector), continuation);
