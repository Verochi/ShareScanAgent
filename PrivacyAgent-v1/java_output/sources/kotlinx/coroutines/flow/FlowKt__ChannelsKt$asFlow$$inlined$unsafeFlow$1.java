...
public final class FlowKt__ChannelsKt$asFlow$$inlined$unsafeFlow$1<T> implements kotlinx.coroutines.flow.Flow<T> {
    public final /* synthetic */ kotlinx.coroutines.channels.BroadcastChannel n;
    ...
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        java.lang.Object emitAll = kotlinx.coroutines.flow.FlowKt.emitAll(flowCollector, this.n.openSubscription(), continuation);
