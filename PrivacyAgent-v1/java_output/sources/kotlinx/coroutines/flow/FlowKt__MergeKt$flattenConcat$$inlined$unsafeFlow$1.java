...
public final class FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1<T> implements kotlinx.coroutines.flow.Flow<T> {
    ...
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        java.lang.Object collect = this.n.collect(new kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$lambda1$$inlined$collect$1(flowCollector), continuation);
