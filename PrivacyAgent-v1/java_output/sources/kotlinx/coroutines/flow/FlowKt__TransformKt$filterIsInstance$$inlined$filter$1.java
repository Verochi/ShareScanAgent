...
public final class FlowKt__TransformKt$filterIsInstance$$inlined$filter$1 implements kotlinx.coroutines.flow.Flow<java.lang.Object> {
    ...
    public static final class AnonymousClass2 implements kotlinx.coroutines.flow.FlowCollector<java.lang.Object> {
        public final /* synthetic */ kotlinx.coroutines.flow.FlowCollector n;

        @kotlin.Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
        @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterIsInstance$$inlined$filter$1$2", f = "Transform.kt", i = {}, l = {com.bytedance.sdk.openadsdk.downloadnew.core.TTDownloadField.CALL_DOWNLOAD_MODEL_SET_APP_ICON}, m = "emit", n = {}, s = {})
            ...
            if (continuation instanceof kotlinx.coroutines.flow.FlowKt__TransformKt$filterIsInstance$$inlined$filter$1.AnonymousClass2.AnonymousClass1) {
                ...
                if ((i2 & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        if (kotlin.coroutines.jvm.internal.Boxing.boxBoolean(obj instanceof java.lang.Object).booleanValue()) {
    ...
    @org.jetbrains.annotations.Nullable
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super java.lang.Object> flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        java.lang.Object coroutine_suspended;
    ...
    public java.lang.Object collect$$forInline(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        kotlin.jvm.internal.InlineMarker.mark(4);
        new kotlinx.coroutines.flow.FlowKt__TransformKt$filterIsInstance$$inlined$filter$1.AnonymousClass1(continuation);
        kotlin.jvm.internal.InlineMarker.mark(5);
        kotlinx.coroutines.flow.Flow flow = this.n;
        kotlin.jvm.internal.Intrinsics.needClassReification();
