...
public final class FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    public final /* synthetic */ kotlin.jvm.internal.Ref.ObjectRef n;

    public FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1(kotlin.jvm.internal.Ref.ObjectRef objectRef) {
        this.n = objectRef;
    }
    ...
    public java.lang.Object emit(T t, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        T t3 = (T) kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL;
        if (t2 == t3) {
            objectRef.element = t;
            z = true;
        } else {
