...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$1<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    public final /* synthetic */ kotlin.jvm.internal.Ref.ObjectRef n;

    public FlowKt__ReduceKt$first$$inlined$collectWhile$1(kotlin.jvm.internal.Ref.ObjectRef objectRef) {
        this.n = objectRef;
    }
