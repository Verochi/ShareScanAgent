...
public final class FlowKt__DelayKt$debounceInternal$1$values$1$invokeSuspend$$inlined$collect$1<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    public final /* synthetic */ kotlinx.coroutines.channels.ProducerScope n;

    public FlowKt__DelayKt$debounceInternal$1$values$1$invokeSuspend$$inlined$collect$1(kotlinx.coroutines.channels.ProducerScope producerScope) {
    ...
    public java.lang.Object emit(T t, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        kotlinx.coroutines.channels.ProducerScope producerScope = this.n;
        if (t == null) {
