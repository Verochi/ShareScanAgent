...
public final class FlowKt__LimitKt$take$lambda7$$inlined$collect$1<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    ...
    public FlowKt__LimitKt$take$lambda7$$inlined$collect$1(kotlin.jvm.internal.Ref.IntRef intRef, int i, kotlinx.coroutines.flow.FlowCollector flowCollector) {
        this.n = intRef;
        this.t = i;
    ...
    public java.lang.Object emit(T t, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        if (i < this.t) {
            ...
            e = kotlinx.coroutines.flow.FlowKt__LimitKt.e(this.u, t, continuation);
