...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2 implements kotlinx.coroutines.flow.Flow {
    ...
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.Object combineInternal = kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$1(this.n), new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$2(this.t, null), continuation);
    ...
    public java.lang.Object collect$$forInline(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        ...
        new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2.AnonymousClass1(continuation);
        kotlin.jvm.internal.InlineMarker.mark(5);
        kotlinx.coroutines.flow.Flow[] flowArr = this.n;
        kotlin.jvm.internal.Intrinsics.needClassReification();
        kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$1 flowKt__ZipKt$combine$5$1 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$1(this.n);
        kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$2 flowKt__ZipKt$combine$5$2 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$5$2(this.t, null);
