...
public final class FlowKt__MergeKt$flatMapConcat$$inlined$map$1<R> implements kotlinx.coroutines.flow.Flow<kotlinx.coroutines.flow.Flow<? extends R>> {
    ...
    public FlowKt__MergeKt$flatMapConcat$$inlined$map$1(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function2 function2) {
        this.n = flow;
        this.t = function2;
    }
    ...
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        java.lang.Object coroutine_suspended;
        java.lang.Object collect = this.n.collect(new kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapConcat$$inlined$map$1.AnonymousClass2(flowCollector, this.t), continuation);
        coroutine_suspended = kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
