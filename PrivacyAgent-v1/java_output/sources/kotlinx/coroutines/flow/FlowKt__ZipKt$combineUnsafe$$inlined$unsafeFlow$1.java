...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements kotlinx.coroutines.flow.Flow {
    ...
    public java.lang.Object collect(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.Object combineInternal = kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, p, new kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$1$1(this.t, null), continuation);
    ...
    public java.lang.Object collect$$forInline(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector flowCollector, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation continuation) {
        ...
        new kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1.AnonymousClass1(continuation);
        kotlin.jvm.internal.InlineMarker.mark(5);
        kotlinx.coroutines.flow.Flow[] flowArr = this.n;
        p = kotlinx.coroutines.flow.FlowKt__ZipKt.p();
        kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$1$1 flowKt__ZipKt$combineUnsafe$1$1 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$1$1(this.t, null);
        kotlin.jvm.internal.InlineMarker.mark(0);
        kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, p, flowKt__ZipKt$combineUnsafe$1$1, continuation);
