...
public final class CancellableFlowImpl$collect$$inlined$collect$1<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    public final /* synthetic */ kotlinx.coroutines.flow.FlowCollector n;

    public CancellableFlowImpl$collect$$inlined$collect$1(kotlinx.coroutines.flow.FlowCollector flowCollector) {
    ...
    public java.lang.Object emit(T t, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        java.lang.Object emit = this.n.emit(t, continuation);
