...
public final class FlowKt__ZipKt$combine$6$1 extends kotlin.jvm.internal.Lambda implements kotlin.jvm.functions.Function0 {
    final /* synthetic */ kotlinx.coroutines.flow.Flow[] $flowArray;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combine$6$1(kotlinx.coroutines.flow.Flow[] flowArr) {
        super(0);
