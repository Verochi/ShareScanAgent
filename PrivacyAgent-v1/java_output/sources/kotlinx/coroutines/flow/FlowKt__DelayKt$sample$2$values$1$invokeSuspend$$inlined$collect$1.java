...
public final class FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    public final /* synthetic */ kotlinx.coroutines.channels.ProducerScope n;

    public FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1(kotlinx.coroutines.channels.ProducerScope producerScope) {
