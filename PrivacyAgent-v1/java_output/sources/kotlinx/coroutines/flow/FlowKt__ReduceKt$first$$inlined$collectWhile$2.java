...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements kotlinx.coroutines.flow.FlowCollector<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", f = "Reduce.kt", i = {0, 0}, l = {144}, m = "emit", n = {"this", "it"}, s = {"L$0", "L$1"})
        ...
        if (continuation instanceof kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2.AnonymousClass1) {
            ...
            if ((i2 & Integer.MIN_VALUE) != 0) {
                ...
                if (((java.lang.Boolean) obj).booleanValue()) {
                    flowKt__ReduceKt$first$$inlined$collectWhile$2.t.element = t;
                    z = false;
                }
