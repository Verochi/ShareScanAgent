...
public final class AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 extends kotlinx.coroutines.internal.LockFreeLinkedListNode.CondAddOp {
    public final /* synthetic */ kotlinx.coroutines.internal.LockFreeLinkedListNode b;
    public final /* synthetic */ kotlinx.coroutines.channels.AbstractSendChannel c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1(kotlinx.coroutines.internal.LockFreeLinkedListNode lockFreeLinkedListNode, kotlinx.coroutines.channels.AbstractSendChannel abstractSendChannel) {
        super(lockFreeLinkedListNode);
        this.b = lockFreeLinkedListNode;
        this.c = abstractSendChannel;
    }
