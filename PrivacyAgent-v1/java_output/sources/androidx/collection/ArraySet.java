...
public final class ArraySet<E> implements java.util.Collection<E>, java.util.Set<E> {
    ...
    public class AnonymousClass1 extends androidx.collection.MapCollections<E, E> {
    ...
    public ArraySet(@androidx.annotation.Nullable androidx.collection.ArraySet<E> arraySet) {
        this();
        if (arraySet != 0) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public ArraySet(@androidx.annotation.Nullable java.util.Collection<E> collection) {
        this();
        if (collection != 0) {
            addAll(collection);
        }
    ...
    private androidx.collection.MapCollections<E, E> getCollection() {
        if (this.mCollections == null) {
            this.mCollections = new androidx.collection.ArraySet.AnonymousClass1();
        }
    ...
    private int indexOf(java.lang.Object obj, int i) {
        ...
        int binarySearch = androidx.collection.ContainerHelpers.binarySearch(this.mHashes, i2, i);
    ...
    private int indexOfNull() {
        ...
        int binarySearch = androidx.collection.ContainerHelpers.binarySearch(this.mHashes, i, 0);
    ...
    public boolean add(@androidx.annotation.Nullable E e) {
        int i;
        int indexOf;
        if (e == null) {
            indexOf = indexOfNull();
    ...
    public void addAll(@androidx.annotation.NonNull androidx.collection.ArraySet<? extends E> arraySet) {
    ...
    @Override // java.util.Collection, java.util.Set
    public boolean addAll(@androidx.annotation.NonNull java.util.Collection<? extends E> collection) {
    ...
    @Override // java.util.Collection, java.util.Set
    public boolean contains(@androidx.annotation.Nullable java.lang.Object obj) {
    ...
    public int indexOf(@androidx.annotation.Nullable java.lang.Object obj) {
    ...
    @Override // java.util.Collection, java.util.Set
    public boolean remove(@androidx.annotation.Nullable java.lang.Object obj) {
    ...
    public boolean removeAll(@androidx.annotation.NonNull androidx.collection.ArraySet<? extends E> arraySet) {
        int i = arraySet.mSize;
        int i2 = this.mSize;
        for (int i3 = 0; i3 < i; i3++) {
    ...
    public E removeAt(int i) {
        ...
        if (i2 <= 1) {
            ...
            if (iArr.length <= 8 || i2 >= iArr.length / 3) {
                ...
                if (i < i3) {
                    int i4 = i + 1;
                    java.lang.System.arraycopy(iArr, i4, iArr, i, i3 - i);
                    java.lang.Object[] objArr2 = this.mArray;
                    java.lang.System.arraycopy(objArr2, i4, objArr2, i, this.mSize - i);
                }
                ...
                if (i < i5) {
                    int i6 = i + 1;
                    java.lang.System.arraycopy(iArr, i6, this.mHashes, i, i5 - i);
                    java.lang.System.arraycopy(objArr, i6, this.mArray, i, this.mSize - i);
                }
            }
        }
        return e;
    ...
    @Override // java.util.Collection, java.util.Set
    @androidx.annotation.NonNull
    public <T> T[] toArray(@androidx.annotation.NonNull T[] tArr) {
