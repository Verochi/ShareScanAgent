...
public class AlertDialogLayout extends androidx.appcompat.widget.LinearLayoutCompat {
    public AlertDialogLayout(@androidx.annotation.Nullable android.content.Context context) {
        super(context);
    }

    public AlertDialogLayout(@androidx.annotation.Nullable android.content.Context context, @androidx.annotation.Nullable android.util.AttributeSet attributeSet) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (((android.widget.LinearLayout.LayoutParams) layoutParams).width == -1) {
                    ...
                    ((android.widget.LinearLayout.LayoutParams) layoutParams).height = childAt.getMeasuredHeight();
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                androidx.appcompat.widget.LinearLayoutCompat.LayoutParams layoutParams = (androidx.appcompat.widget.LinearLayoutCompat.LayoutParams) childAt.getLayoutParams();
                int i12 = ((android.widget.LinearLayout.LayoutParams) layoutParams).gravity;
                if (i12 < 0) {
                    i12 = i10;
                }
                ...
                if (absoluteGravity == 1) {
                    ...
                    int i13 = paddingTop + ((android.widget.LinearLayout.LayoutParams) layoutParams).topMargin;
                    setChildFrame(childAt, i7, i13, measuredWidth, measuredHeight2);
                    paddingTop = i13 + measuredHeight2 + ((android.widget.LinearLayout.LayoutParams) layoutParams).bottomMargin;
                } else {
                ...
                int i132 = paddingTop + ((android.widget.LinearLayout.LayoutParams) layoutParams).topMargin;
                setChildFrame(childAt, i7, i132, measuredWidth, measuredHeight2);
                paddingTop = i132 + measuredHeight2 + ((android.widget.LinearLayout.LayoutParams) layoutParams).bottomMargin;
            }
        }
    }
