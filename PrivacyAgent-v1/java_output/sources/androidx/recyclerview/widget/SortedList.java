...
public class SortedList<T> {
    ...
    public SortedList(@androidx.annotation.NonNull java.lang.Class<T> cls, @androidx.annotation.NonNull androidx.recyclerview.widget.SortedList.Callback<T> callback) {
        this(cls, callback, 10);
    }

    public SortedList(@androidx.annotation.NonNull java.lang.Class<T> cls, @androidx.annotation.NonNull androidx.recyclerview.widget.SortedList.Callback<T> callback, int i) {
        this.mTClass = cls;
    ...
    private void replaceAllInternal(@androidx.annotation.NonNull T[] tArr) {
        boolean z = !(this.mCallback instanceof androidx.recyclerview.widget.SortedList.BatchedCallback);
        if (z) {
            beginBatchedUpdates();
        }
    ...
    private int sortAndDedup(@androidx.annotation.NonNull T[] tArr) {
        if (tArr.length == 0) {
            return 0;
        }
    ...
    public void addAll(@androidx.annotation.NonNull java.util.Collection<T> collection) {
    ...
    public void addAll(@androidx.annotation.NonNull T... tArr) {
        addAll(tArr, false);
    }

    public void addAll(@androidx.annotation.NonNull T[] tArr, boolean z) {
        throwIfInMutationOperation();
        if (tArr.length == 0) {
            return;
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public void replaceAll(@androidx.annotation.NonNull java.util.Collection<T> collection) {
    ...
    public void replaceAll(@androidx.annotation.NonNull T... tArr) {
        replaceAll(tArr, false);
    }

    public void replaceAll(@androidx.annotation.NonNull T[] tArr, boolean z) {
        throwIfInMutationOperation();
        if (z) {
