...
class ViewBoundsCheck {
    ...
    public ViewBoundsCheck(androidx.recyclerview.widget.ViewBoundsCheck.Callback callback) {
        this.mCallback = callback;
    }

    public android.view.View findOneViewWithinBoundFlags(int i, int i2, int i3, int i4) {
    ...
    public boolean isViewWithinBoundFlags(android.view.View view, int i) {
