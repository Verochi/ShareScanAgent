...
public final class TextViewKt$doOnTextChanged$$inlined$addTextChangedListener$1 implements android.text.TextWatcher {
    final /* synthetic */ kotlin.jvm.functions.Function4 $onTextChanged;

    public TextViewKt$doOnTextChanged$$inlined$addTextChangedListener$1(kotlin.jvm.functions.Function4 function4) {
    ...
    public void onTextChanged(@org.jetbrains.annotations.Nullable java.lang.CharSequence charSequence, int i, int i2, int i3) {
        this.$onTextChanged.invoke(charSequence, java.lang.Integer.valueOf(i), java.lang.Integer.valueOf(i2), java.lang.Integer.valueOf(i3));
    }
}
