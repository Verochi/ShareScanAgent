...
public final class TextViewKt$doBeforeTextChanged$$inlined$addTextChangedListener$1 implements android.text.TextWatcher {
    final /* synthetic */ kotlin.jvm.functions.Function4 $beforeTextChanged;

    public TextViewKt$doBeforeTextChanged$$inlined$addTextChangedListener$1(kotlin.jvm.functions.Function4 function4) {
    ...
    public void beforeTextChanged(@org.jetbrains.annotations.Nullable java.lang.CharSequence charSequence, int i, int i2, int i3) {
        this.$beforeTextChanged.invoke(charSequence, java.lang.Integer.valueOf(i), java.lang.Integer.valueOf(i2), java.lang.Integer.valueOf(i3));
    }
