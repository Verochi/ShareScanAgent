...
public final class BundleCompat {
    ...
    public static android.os.IBinder getBinder(@androidx.annotation.NonNull android.os.Bundle bundle, @androidx.annotation.Nullable java.lang.String str) {
        return bundle.getBinder(str);
    }

    public static void putBinder(@androidx.annotation.NonNull android.os.Bundle bundle, @androidx.annotation.Nullable java.lang.String str, @androidx.annotation.Nullable android.os.IBinder iBinder) {
