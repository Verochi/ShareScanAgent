...
public final class MaybeFilter<T> extends io.reactivex.internal.operators.maybe.AbstractMaybeWithUpstream<T, T> {
    ...
    public static final class FilterMaybeObserver<T> implements io.reactivex.MaybeObserver<T>, io.reactivex.disposables.Disposable {
    ...
    public void subscribeActual(io.reactivex.MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new io.reactivex.internal.operators.maybe.MaybeFilter.FilterMaybeObserver(maybeObserver, this.n));
    }
}
