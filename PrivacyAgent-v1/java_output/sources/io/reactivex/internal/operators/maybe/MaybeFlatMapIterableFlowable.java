...
public final class MaybeFlatMapIterableFlowable<T, R> extends io.reactivex.Flowable<R> {
    ...
    public static final class FlatMapIterableObserver<T, R> extends io.reactivex.internal.subscriptions.BasicIntQueueSubscription<R> implements io.reactivex.MaybeObserver<T> {
        ...
        public void fastPath(org.reactivestreams.Subscriber<? super R> subscriber, java.util.Iterator<? extends R> it) {
    ...
    public void subscribeActual(org.reactivestreams.Subscriber<? super R> subscriber) {
        this.t.subscribe(new io.reactivex.internal.operators.maybe.MaybeFlatMapIterableFlowable.FlatMapIterableObserver(subscriber, this.u));
    }
}
