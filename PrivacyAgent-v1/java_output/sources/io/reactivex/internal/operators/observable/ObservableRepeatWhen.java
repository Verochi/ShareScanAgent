...
public final class ObservableRepeatWhen<T> extends io.reactivex.internal.operators.observable.AbstractObservableWithUpstream<T, T> {
    public final io.reactivex.functions.Function<? super io.reactivex.Observable<java.lang.Object>, ? extends io.reactivex.ObservableSource<?>> n;
    ...
    public static final class RepeatWhenObserver<T> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        public RepeatWhenObserver(io.reactivex.Observer<? super T> observer, io.reactivex.subjects.Subject<java.lang.Object> subject, io.reactivex.ObservableSource<T> observableSource) {
