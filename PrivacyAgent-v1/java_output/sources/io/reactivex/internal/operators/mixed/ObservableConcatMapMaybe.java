...
public final class ObservableConcatMapMaybe<T, R> extends io.reactivex.Observable<R> {
    ...
    public static final class ConcatMapMaybeMainObserver<T, R> extends java.util.concurrent.atomic.AtomicInteger implements io.reactivex.Observer<T>, io.reactivex.disposables.Disposable {
        ...
        public static final class ConcatMapMaybeObserver<R> extends java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> implements io.reactivex.MaybeObserver<R> {
            ...
            public ConcatMapMaybeObserver(io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe.ConcatMapMaybeMainObserver<?, R> concatMapMaybeMainObserver) {
        ...
        public ConcatMapMaybeMainObserver(io.reactivex.Observer<? super R> observer, io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> function, int i, io.reactivex.internal.util.ErrorMode errorMode) {
    ...
    public void subscribeActual(io.reactivex.Observer<? super R> observer) {
        ...
        this.n.subscribe(new io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe.ConcatMapMaybeMainObserver(observer, this.t, this.v, this.u));
    }
}
