...
public final class SequencesKt___SequencesKt$minus$2$iterator$1<T> extends kotlin.jvm.internal.Lambda implements kotlin.jvm.functions.Function1<T, java.lang.Boolean> {
    final /* synthetic */ java.util.Collection<T> $other;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public SequencesKt___SequencesKt$minus$2$iterator$1(java.util.Collection<? extends T> collection) {
        super(1);
    ...
    public /* bridge */ /* synthetic */ java.lang.Boolean invoke(java.lang.Object obj) {
        return invoke((kotlin.sequences.SequencesKt___SequencesKt$minus$2$iterator$1<T>) obj);
    }
}
