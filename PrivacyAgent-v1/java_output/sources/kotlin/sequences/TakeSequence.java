...
public final class TakeSequence<T> implements kotlin.sequences.Sequence<T>, kotlin.sequences.DropTakeSequence<T> {
    ...
    public TakeSequence(@org.jetbrains.annotations.NotNull kotlin.sequences.Sequence<? extends T> sequence, int i) {
    ...
    public kotlin.sequences.Sequence<T> drop(int n) {
        int i = this.count;
        return n >= i ? kotlin.sequences.SequencesKt__SequencesKt.emptySequence() : new kotlin.sequences.SubSequence(this.sequence, n, i);
    }
