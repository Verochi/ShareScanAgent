...
public final class SequencesKt___SequencesKt$minus$4<T> implements kotlin.sequences.Sequence<T> {
    ...
    public SequencesKt___SequencesKt$minus$4(kotlin.sequences.Sequence<? extends T> sequence, kotlin.sequences.Sequence<? extends T> sequence2) {
        this.a = sequence;
        this.b = sequence2;
    }
    ...
    public java.util.Iterator<T> iterator() {
        ...
        return convertToSetForSetOperation.isEmpty() ? this.b.iterator() : kotlin.sequences.SequencesKt___SequencesKt.filterNot(this.b, new kotlin.sequences.SequencesKt___SequencesKt$minus$4$iterator$1(convertToSetForSetOperation)).iterator();
    }
}
