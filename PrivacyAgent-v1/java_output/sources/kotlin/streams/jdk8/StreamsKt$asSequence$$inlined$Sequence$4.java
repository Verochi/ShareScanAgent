...
public final class StreamsKt$asSequence$$inlined$Sequence$4 implements kotlin.sequences.Sequence<java.lang.Double> {
    ...
    public java.util.Iterator<java.lang.Double> iterator() {
        java.util.PrimitiveIterator.OfDouble it;
        it = this.a.iterator();
