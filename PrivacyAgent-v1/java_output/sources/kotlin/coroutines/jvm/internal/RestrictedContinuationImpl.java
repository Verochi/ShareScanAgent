...
public abstract class RestrictedContinuationImpl extends kotlin.coroutines.jvm.internal.BaseContinuationImpl {
    public RestrictedContinuationImpl(@org.jetbrains.annotations.Nullable kotlin.coroutines.Continuation<java.lang.Object> continuation) {
        super(continuation);
        if (continuation != null) {
            if (!(continuation.getN() == kotlin.coroutines.EmptyCoroutineContext.INSTANCE)) {
