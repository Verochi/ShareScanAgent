...
public final class ComparisonsKt__ComparisonsKt$then$1<T> implements java.util.Comparator {
    public final /* synthetic */ java.util.Comparator<T> n;
    public final /* synthetic */ java.util.Comparator<? super T> t;

    public ComparisonsKt__ComparisonsKt$then$1(java.util.Comparator<T> comparator, java.util.Comparator<? super T> comparator2) {
        this.n = comparator;
        this.t = comparator2;
    }
