...
public enum CharDirectionality {
    ...
    public static final class Companion {
        ...
        public final java.util.Map<java.lang.Integer, kotlin.text.CharDirectionality> a() {
        ...
        public final kotlin.text.CharDirectionality valueOf(int directionality) {
            kotlin.text.CharDirectionality charDirectionality = a().get(java.lang.Integer.valueOf(directionality));
    ...
    static {
        kotlin.Lazy<java.util.Map<java.lang.Integer, kotlin.text.CharDirectionality>> lazy;
        lazy = kotlin.LazyKt__LazyJVMKt.lazy(kotlin.text.CharDirectionality$Companion$directionalityMap$2.INSTANCE);
