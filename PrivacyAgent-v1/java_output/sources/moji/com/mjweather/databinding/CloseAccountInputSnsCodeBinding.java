...
public final class CloseAccountInputSnsCodeBinding implements androidx.viewbinding.ViewBinding {
    ...
    @androidx.annotation.NonNull
    public final android.widget.TextView tvActionClose;
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.CloseAccountInputSnsCodeBinding bind(@androidx.annotation.NonNull android.view.View view) {
                    ...
                    if (imageView2 != null) {
                        ...
                        if (imageView3 != null) {
                            ...
                            if (textView != null && (findChildViewById = androidx.viewbinding.ViewBindings.findChildViewById(view, (i = moji.com.mjweather.R.id.title_bar))) != null) {
                                i = moji.com.mjweather.R.id.tv_action_close;
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            ...
                                            if (textView5 != null) {
                                                return new moji.com.mjweather.databinding.CloseAccountInputSnsCodeBinding((androidx.constraintlayout.widget.ConstraintLayout) view, editText, relativeLayout, imageView, imageView2, imageView3, textView, findChildViewById, textView2, textView3, textView4, textView5);
                                            }
                                        }
                                    }
                                }
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.CloseAccountInputSnsCodeBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.CloseAccountInputSnsCodeBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.Nullable android.view.ViewGroup viewGroup, boolean z) {
        android.view.View inflate = layoutInflater.inflate(moji.com.mjweather.R.layout.close_account_input_sns_code, viewGroup, false);
        if (z) {
