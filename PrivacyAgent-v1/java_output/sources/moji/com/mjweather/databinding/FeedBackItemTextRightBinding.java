...
public final class FeedBackItemTextRightBinding implements androidx.viewbinding.ViewBinding {
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.FeedBackItemTextRightBinding bind(@androidx.annotation.NonNull android.view.View view) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (textView4 != null) {
                                                return new moji.com.mjweather.databinding.FeedBackItemTextRightBinding((android.widget.LinearLayout) view, imageView, linearLayout, linearLayout2, progressBar, findChildViewById, relativeLayout, relativeLayout2, textView, textView2, textView3, textView4);
                                            }
                                        }
                                    }
                                }
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.FeedBackItemTextRightBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.FeedBackItemTextRightBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.Nullable android.view.ViewGroup viewGroup, boolean z) {
        android.view.View inflate = layoutInflater.inflate(moji.com.mjweather.R.layout.feed_back_item_text_right, viewGroup, false);
        if (z) {
