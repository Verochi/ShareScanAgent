...
public final class ActivityAccountBindEmailBinding implements androidx.viewbinding.ViewBinding {
    ...
    public ActivityAccountBindEmailBinding(@androidx.annotation.NonNull android.widget.LinearLayout linearLayout, @androidx.annotation.NonNull android.widget.EditText editText, @androidx.annotation.NonNull android.widget.ImageView imageView, @androidx.annotation.NonNull android.widget.TextView textView, @androidx.annotation.NonNull com.moji.titlebar.MJTitleBar mJTitleBar, @androidx.annotation.NonNull android.widget.TextView textView2, @androidx.annotation.NonNull android.widget.TextView textView3, @androidx.annotation.NonNull android.widget.TextView textView4) {
        this.n = linearLayout;
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.ActivityAccountBindEmailBinding bind(@androidx.annotation.NonNull android.view.View view) {
                ...
                if (textView != null && (findChildViewById = androidx.viewbinding.ViewBindings.findChildViewById(view, (i = moji.com.mjweather.R.id.title_bar))) != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (textView4 != null) {
                                return new moji.com.mjweather.databinding.ActivityAccountBindEmailBinding((android.widget.LinearLayout) view, editText, imageView, textView, findChildViewById, textView2, textView3, textView4);
                            }
                        }
                    }
                }
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.ActivityAccountBindEmailBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.ActivityAccountBindEmailBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.Nullable android.view.ViewGroup viewGroup, boolean z) {
        android.view.View inflate = layoutInflater.inflate(moji.com.mjweather.R.layout.activity_account_bind_email, viewGroup, false);
        if (z) {
