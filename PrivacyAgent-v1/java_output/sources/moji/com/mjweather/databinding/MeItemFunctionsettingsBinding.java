...
public final class MeItemFunctionsettingsBinding implements androidx.viewbinding.ViewBinding {

    @androidx.annotation.NonNull
    public final com.moji.imageview.MJImageView ivRedPoint;
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.MeItemFunctionsettingsBinding bind(@androidx.annotation.NonNull android.view.View view) {
        ...
        int i = moji.com.mjweather.R.id.iv_red_point;
        ...
        if (findChildViewById4 != null && (findChildViewById = androidx.viewbinding.ViewBindings.findChildViewById(view, (i = moji.com.mjweather.R.id.iv_tool))) != null && (findChildViewById2 = androidx.viewbinding.ViewBindings.findChildViewById(view, (i = moji.com.mjweather.R.id.me_ad_view))) != null) {
            ...
            if (relativeLayout != null && (findChildViewById3 = androidx.viewbinding.ViewBindings.findChildViewById(view, (i = moji.com.mjweather.R.id.tv_tool))) != null) {
                return new moji.com.mjweather.databinding.MeItemFunctionsettingsBinding((androidx.constraintlayout.widget.ConstraintLayout) view, findChildViewById4, findChildViewById, findChildViewById2, relativeLayout, findChildViewById3);
            }
        }
    ...
    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.MeItemFunctionsettingsBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @androidx.annotation.NonNull
    public static moji.com.mjweather.databinding.MeItemFunctionsettingsBinding inflate(@androidx.annotation.NonNull android.view.LayoutInflater layoutInflater, @androidx.annotation.Nullable android.view.ViewGroup viewGroup, boolean z) {
        android.view.View inflate = layoutInflater.inflate(moji.com.mjweather.R.layout.me_item_functionsettings, viewGroup, false);
        if (z) {
